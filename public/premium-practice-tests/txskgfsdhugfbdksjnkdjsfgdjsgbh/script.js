...
async function fetchQuizData() {
    try {
        const response = await fetch('../../csv/texas_premium_practice.csv');
...
function getChapterTitle(chapterNum) {
    switch(chapterNum) {
        case "1": return "Practice Test #1";
        case "2": return "Practice Test #2";
        case "3": return "Practice Test #3";
        case "4": return "Practice Test #4";
        case "5": return "Practice Test #5";
        case "6": return "Practice Test #6";
        case "7": return "Practice Test #7";
        case "8": return "Practice Test #8";
...
function initializeChapters() {
    Object.keys(quizData).forEach(chapter => {
        ...
        menuChapterBtn.textContent = `${chapterData.title}`;
