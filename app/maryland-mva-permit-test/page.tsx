...
// State configuration
const STATE_KEY = 'maryland' as const
const STATE_NAME = 'Maryland'
const STATE_CODE = 'MD'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, marylandStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: marylandStateData.seo,
  pricing: marylandStateData.pricing,
  faq: marylandStateData.faq,
  lastUpdated: marylandStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(marylandStateData.faq)
...
export default function MarylandPermitTestPage() {
  return (
    <>
