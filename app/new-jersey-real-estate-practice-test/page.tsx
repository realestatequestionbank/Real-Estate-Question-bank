...
// State configuration
const STATE_KEY = 'new-jersey' as const
const STATE_NAME = 'New Jersey'
const STATE_CODE = 'NJ'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, newjerseyStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: newjerseyStateData.seo,
  pricing: newjerseyStateData.pricing,
  faq: newjerseyStateData.faq,
  lastUpdated: newjerseyStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(newjerseyStateData.faq)
...
export default function NewJerseyPermitTestPage() {
  return (
    <>
