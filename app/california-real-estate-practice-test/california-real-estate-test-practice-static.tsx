...
import { californiaStaticPageData } from './static-data'
...
const {
  ...
  features,
  breadcrumbs,
} = californiaStaticPageData

export default function CaliforniaRealEstateTestPractice() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto w-full">
              ...
              <div className="text-left lg:-mt-12">
                ...
                <p className="text-base text-gray-600 mb-3 md:mb-4 lg:mb-5 max-w-2xl lg:max-w-none animate-fade-in-up delay-200">
                  Imagine you are at the Real Estate and you know you will pass because you have already seen every question before. Join 25K+ students using our state-specific California Real Estate question bank and pass on your first attempt.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start mb-8 md:mb-12 lg:mb-16 animate-fade-in-up">
                ...
                <div className="md:col-span-2 text-left">
                  ...
                  <p className="text-base text-gray-600 leading-relaxed">
                    Learning how to pass the California Real Estate Exam requires understanding national real estate principles, state-specific laws, contracts, agency relationships, and property math. Our comprehensive study system helps you prepare for the California Real Estate Exam with realistic practice questions and detailed explanations.{' '}
                    <span>
                      To prepare for your real estate exam, check out our official{' '}
                      <a
                        href="/state-guides/california"
                        target="_blank"
                      ...
                      >
                        California DRE Exam State Guide
                      </a>
                      {stateData.handbookUrl && (
                        <>
                          ...
                          <a
                            ...
                            className="text-[#007aff] font-bold underline decoration-transparent hover:decoration-[#007aff] underline-offset-4 transition-all duration-300"
                          >
                            official California DRE Handbook
                          </a>
                        </>
                      )}
                      .
                ...
                <div className="bg-[#007aff]/5 rounded-lg p-5 border border-[#007aff]/10 flex flex-col justify-center w-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <Link
                      href="/california-real-estate-practice-test-150-questions"
                      className="flex items-center text-sm font-semibold text-gray-900 hover:text-[#007aff] transition-all duration-200 group"
                    >
                      <div className="w-8 h-8 rounded-lg bg-[#007aff]/10 flex items-center justify-center mr-3 text-[#007aff] group-hover:scale-105 transition-transform flex-shrink-0">
              ...
              <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 rounded-3xl p-6 md:p-8 lg:p-12 shadow-lg border border-green-100 mb-8 md:mb-12 lg:mb-16 animate-fade-in-up delay-150">
                <div className="text-center max-w-3xl mx-auto">
                  ...
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                    Free California Real Estate Practice Test PDF
                  </h2>

                  <p className="text-base md:text-lg text-gray-700 mb-6 md:mb-8 leading-relaxed">
                    Download our comprehensive practice test with <strong>50 California-specific questions</strong> with answers. Perfect for offline study and test preparation!
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-8 text-left">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700 font-medium">50 California Real Estate questions</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                        <CheckCircle className="w-4 h-4 text-white" />
                  ...
                  {/* Download Button */}
                  <Button
                    onClick={() => window.open('/free-real-estate-practice-questions-PDF/Free-California-Real-Estate-Practice-Questions.pdf', '_blank')}
                    size="lg"
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8 md:mb-12 animate-fade-in-up">
                ...
                <p className="text-xs md:text-sm lg:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Questions are manually curated by the Real Estate Question Bank content team using the <Link href="/handbooks/california" className="font-medium text-[#007aff] underline decoration-transparent hover:decoration-[#007aff] underline-offset-4 transition-all duration-300">California Real Estate Handbook (2026)</Link>. Each page in the Real Estate handbook is mapped to real real estate exam questions – so you practice with questions that closely mirror the actual Real Estate Exam.
                </p>
              </div>
              ...
              >
                <div>
                  <p className="font-semibold text-gray-900 text-sm md:text-base group-hover:text-[#007aff] transition-colors">Try the Exact 150-Question Format</p>
                  <p className="text-xs text-gray-500 mt-0.5">Matches the real California Real Estate Exam — 150 questions, need 105 to pass (70%)</p>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6">
                Official California Real Estate Resources
              </h2>
              <p className="text-sm md:text-base lg:text-lg xl:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Access official California Real Estate websites for additional information, services, and test preparation materials.
              </p>
            </div>
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory pb-6 -mx-4 px-4 gap-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6 md:overflow-visible md:pb-0 md:mx-0 md:px-0 scrollbar-hide">
              {/* California Real Estate Main Page */}
              <a
              ...
              <a
                href="https://www.dre.ca.gov/files/pdf/re4.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="snap-center flex-shrink-0 w-[70vw] md:w-auto bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 group"
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Official exam guidelines, instructions, and rules
                </p>
              </a>
              ...
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Official pre-licensing education requirements and forms
                </p>
              </a>
              ...
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Apply for exam, schedule test, and check application status online
                </p>
              </a>
            </div>
            ...
            <div className="text-center mt-8 md:mt-12">
              <p className="text-xs md:text-sm text-gray-500">
                These are official <a href="https://www.dre.ca.gov/" target="_blank" rel="noopener noreferrer" className="text-[#007aff] underline decoration-transparent hover:decoration-[#007aff] underline-offset-2 transition-all duration-300">California Department of Real Estate (DRE)</a> resources. Real Estate Question Bank is not affiliated with the California DRE.
              </p>
            </div>
          </div>
        </div>
