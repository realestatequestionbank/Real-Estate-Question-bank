...
// State configuration
const STATE_KEY = 'new-mexico' as const
const STATE_NAME = 'New Mexico'
const STATE_CODE = 'NM'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, newmexicoStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: newmexicoStateData.seo,
  pricing: newmexicoStateData.pricing,
  faq: newmexicoStateData.faq,
  lastUpdated: newmexicoStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(newmexicoStateData.faq)
...
export default function NewMexicoPermitTestPage() {
  return (
    <>
