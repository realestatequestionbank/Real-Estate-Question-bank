...
// Pre-computed static data for North Carolina Real Estate Exam practice page
export const northcarolinaStaticPageData = {
  state: 'north-carolina' as const,
  stateInfo: STATES['north-carolina'],
  departmentInfo: getDepartmentName('north-carolina'),
  stateData: {
    ...northcarolinaStateData,
    handbookUrl: '',
  },
  ...
  formattedQuestionCount: formatQuestionCount(northcarolinaStateData.pricing.premiumQuestions),
  ...
  breadcrumbs: [
    ...
    { label: 'North Carolina', href: null }, // Current page
  ],
}