...
// State configuration
const STATE_KEY = 'nevada' as const
const STATE_NAME = 'Nevada'
const STATE_CODE = 'NV'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, nevadaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: nevadaStateData.seo,
  pricing: nevadaStateData.pricing,
  faq: nevadaStateData.faq,
  lastUpdated: nevadaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(nevadaStateData.faq)
...
export default function NevadaPermitTestPage() {
  return (
    <>
