...
export const metadata: Metadata = {
    title: `FREE Indiana BMV Real Estate Practice Test 2026 — 130 Questions | Real Estate Question Bank`,
    description: 'Free 130-question Indiana Real Estate practice test. Matches the official exam format. Need 97/130 correct to pass (75%). Updated for 2026.',
    keywords: [
        'indiana real-estate practice test 130 questions',
    ...
    openGraph: {
        title: `FREE Indiana BMV Real Estate Practice Test 2026 — 130 Questions`,
        description: 'Free 130-question Indiana Real Estate practice test. Matches the official exam format. Need 97/130 correct to pass (75%). Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'Indiana BMV Real Estate Practice Test 130 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `Indiana BMV Real Estate Practice Test 2026 — 130 Questions`,
        description: 'Free 130-question Indiana Real Estate practice test. Matches the official exam format. Need 97/130 correct to pass (75%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Indiana BMV Real Estate Practice Test 2026 — 130 Questions, Answers & Explanations",
    "description": "Take a free 130-question Indiana Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
