...
export const metadata: Metadata = {
    title: `FREE New Hampshire Real Estate Real Estate Practice Test 2026 — 120 Questions | Real Estate Question Bank`,
    description: 'Free 120-question New Hampshire Real Estate practice test. Matches the official exam format. Need 84/120 correct to pass (70%). Updated for 2026.',
    keywords: [
    ...
    openGraph: {
        title: `FREE New Hampshire Real Estate Real Estate Practice Test 2026 — 120 Questions`,
        description: 'Free 120-question New Hampshire Real Estate practice test. Matches the official exam format. Need 84/120 correct to pass (70%). Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'New Hampshire Real Estate Real Estate Practice Test 120 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `New Hampshire Real Estate Real Estate Practice Test 2026 — 120 Questions`,
        description: 'Free 120-question New Hampshire Real Estate practice test. Matches the official exam format. Need 84/120 correct to pass (70%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "New Hampshire Real Estate Real Estate Practice Test 2026 — 120 Questions, Answers & Explanations",
