...
import { newyorkStaticPageData } from './static-data'
...
const {
  ...
  features,
  breadcrumbs,
} = newyorkStaticPageData

export default function NewYorkRealEstateTestPractice() {
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start mb-8 md:mb-12 lg:mb-16 animate-fade-in-up">
                ...
                <div className="md:col-span-2 text-left">
                  ...
                  <p className="text-base text-gray-600 leading-relaxed">
                    ...
                    <span>
                      ...
                      >
                        New York NYDOS Exam State Guide
                      </a>
                      {stateData.handbookUrl && (
                        <>
                          ...
                          <a
                            ...
                            className="text-[#007aff] font-bold underline decoration-transparent hover:decoration-[#007aff] underline-offset-4 transition-all duration-300"
                          >
                            official New York NYDOS Handbook
                          </a>
                        </>
                      )}
                      .
                ...
                <div className="bg-[#007aff]/5 rounded-lg p-5 border border-[#007aff]/10 flex flex-col justify-center w-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <Link
                      href="/new-york-real-estate-practice-test-75-questions"
                      className="flex items-center text-sm font-semibold text-gray-900 hover:text-[#007aff] transition-all duration-200 group"
                    >
                      <div className="w-8 h-8 rounded-lg bg-[#007aff]/10 flex items-center justify-center mr-3 text-[#007aff] group-hover:scale-105 transition-transform flex-shrink-0">
              ...
              <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 rounded-3xl p-6 md:p-8 lg:p-12 shadow-lg border border-green-100 mb-8 md:mb-12 lg:mb-16 animate-fade-in-up delay-150">
                <div className="text-center max-w-3xl mx-auto">
                  ...
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                    Free New York Real Estate Practice Test PDF
                  </h2>

                  <p className="text-base md:text-lg text-gray-700 mb-6 md:mb-8 leading-relaxed">
                    Download our comprehensive practice test with <strong>50 New York-specific questions</strong> with answers. Perfect for offline study and test preparation!
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-8 text-left">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700 font-medium">50 New York Real Estate questions</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                        <CheckCircle className="w-4 h-4 text-white" />
                  ...
                  {/* Download Button */}
                  <Button
                    onClick={() => window.open('/free-real-estate-practice-questions-PDF/Free-New-York-Real-Estate-Practice-Questions.pdf', '_blank')}
                    size="lg"
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8 md:mb-12 animate-fade-in-up">
                ...
                <p className="text-xs md:text-sm lg:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Questions are manually curated by the Real Estate Question Bank content team using the <Link href="/handbooks/new-york" className="font-medium text-[#007aff] underline decoration-transparent hover:decoration-[#007aff] underline-offset-4 transition-all duration-300">New York Real Estate Handbook (2026)</Link>. Each page in the Real Estate handbook is mapped to real real estate exam questions – so you practice with questions that closely mirror the actual Real Estate Exam.
                </p>
              </div>
              ...
              >
                <div>
                  <p className="font-semibold text-gray-900 text-sm md:text-base group-hover:text-[#007aff] transition-colors">Try the Exact 75-Question Format</p>
                  <p className="text-xs text-gray-500 mt-0.5">Matches the real New York Real Estate Exam — 75 questions, need 53 to pass (70%)</p>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6">
                Official New York Real Estate Resources
              </h2>
              <p className="text-sm md:text-base lg:text-lg xl:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Access official New York Real Estate websites for additional information, services, and test preparation materials.
              </p>
            </div>
