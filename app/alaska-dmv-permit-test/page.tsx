...
// State configuration
const STATE_KEY = 'alaska' as const
const STATE_NAME = 'Alaska'
const STATE_CODE = 'AK'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, alaskaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: alaskaStateData.seo,
  pricing: alaskaStateData.pricing,
  faq: alaskaStateData.faq,
  lastUpdated: alaskaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(alaskaStateData.faq)
...
export default function AlaskaPermitTestPage() {
  return (
    <>
