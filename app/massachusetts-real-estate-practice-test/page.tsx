...
// State configuration
const STATE_KEY = 'massachusetts' as const
const STATE_NAME = 'Massachusetts'
const STATE_CODE = 'MA'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, massachusettsStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: massachusettsStateData.seo,
  pricing: massachusettsStateData.pricing,
  faq: massachusettsStateData.faq,
  lastUpdated: massachusettsStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(massachusettsStateData.faq)
...
export default function MassachusettsPermitTestPage() {
  return (
    <>
