...
// State configuration
const STATE_KEY = 'south-dakota' as const
const STATE_NAME = 'South Dakota'
const STATE_CODE = 'SD'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, southdakotaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: southdakotaStateData.seo,
  pricing: southdakotaStateData.pricing,
  faq: southdakotaStateData.faq,
  lastUpdated: southdakotaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(southdakotaStateData.faq)
...
export default function SouthDakotaPermitTestPage() {
  return (
    <>
