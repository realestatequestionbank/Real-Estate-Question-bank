...
// State configuration
const STATE_KEY = 'utah' as const
const STATE_NAME = 'Utah'
const STATE_CODE = 'UT'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, utahStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: utahStateData.seo,
  pricing: utahStateData.pricing,
  faq: utahStateData.faq,
  lastUpdated: utahStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(utahStateData.faq)
...
export default function UtahPermitTestPage() {
  return (
    <>
