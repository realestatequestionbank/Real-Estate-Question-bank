...
export const metadata: Metadata = {
  title: 'North Dakota Real Estate Exam Guide 2026 â€” Eligibility, Fees & Rules | Real Estate Question Bank',
  description:
  ...
  openGraph: {
    title: 'North Dakota Real Estate Exam Guide â€” Everything You Need to Know',
    description:
