...
export const metadata: Metadata = {
  title: 'Pennsylvania Real Estate Exam Guide 2026 â€” Eligibility, Fees & Rules | Real Estate Question Bank',
  description:
  ...
  openGraph: {
    title: 'Pennsylvania Real Estate Exam Guide â€” Everything You Need to Know',
    description:
