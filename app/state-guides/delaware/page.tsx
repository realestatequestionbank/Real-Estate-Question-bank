  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You must be at least 18 years old to apply for a real estate salesperson license in Delaware.',
      },
    },
    {
      '@type': 'Question',
      name: 'How many questions are on the Delaware real estate licensing exam?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The Delaware real estate licensing exam typically consists of a national section and a state-specific section, totaling between 100 to 150 multiple-choice questions depending on state regulatory formats.',
      },
    },
    {
      '@type': 'Question',
      name: 'What regulatory body issues real estate licenses in Delaware?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Real estate licenses in Delaware are issued by the Delaware Real Estate Commission (DREC). You can visit their official portal for registration and forms.',
      },
    },
    {
      '@type': 'Question',
      name: 'What happens if I fail the Delaware real estate exam?',
      acceptedAnswer: {
        '@type': 'Answer',
