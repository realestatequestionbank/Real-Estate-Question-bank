...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How old do you have to be to get a real estate license in Nevada?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You must be at least 18 years old to apply for a real estate salesperson license in Nevada.',
      },
    },
    {
      '@type': 'Question',
      name: 'How many questions are on the Nevada real estate licensing exam?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The Nevada real estate licensing exam typically consists of a national section and a state-specific section, totaling between 100 to 150 multiple-choice questions depending on state regulatory formats.',
      },
    },
    {
      '@type': 'Question',
      name: 'What regulatory body issues real estate licenses in Nevada?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Real estate licenses in Nevada are issued by the Nevada Real Estate Division (NRED). You can visit their official portal for registration and forms.',
      },
    },
    {
      '@type': 'Question',
