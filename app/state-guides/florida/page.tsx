...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How old do you have to be to get a real estate license in Florida?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You must be at least 18 years old to apply for a real estate salesperson license in Florida.',
      },
    },
    {
      '@type': 'Question',
      name: 'How many questions are on the Florida real estate licensing exam?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The Florida real estate licensing exam typically consists of a national section and a state-specific section, totaling between 100 to 150 multiple-choice questions depending on state regulatory formats.',
      },
    },
    {
      '@type': 'Question',
      name: 'What regulatory body issues real estate licenses in Florida?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Real estate licenses in Florida are issued by the Florida Real Estate Commission (FREC). You can visit their official portal for registration and forms.',
      },
    },
    {
      '@type': 'Question',
