...
export const metadata: Metadata = {
  title: 'Hawaii Real Estate Exam Guide 2026 â€” Eligibility, Fees & Rules | Real Estate Question Bank',
  description:
  ...
  openGraph: {
    title: 'Hawaii Real Estate Exam Guide â€” Everything You Need to Know',
    description:
