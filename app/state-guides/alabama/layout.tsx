...
export const metadata: Metadata = {
  title: 'Alabama Real Estate Exam Guide 2026 â€” Eligibility, Fees & Rules | Real Estate Question Bank',
  description:
  ...
  openGraph: {
    title: 'Alabama Real Estate Exam Guide â€” Everything You Need to Know',
    description:
