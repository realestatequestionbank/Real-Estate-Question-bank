...
export const metadata: Metadata = {
  title: 'Michigan Real Estate Exam Guide 2026 — Eligibility, Fees & Rules | Real Estate Question Bank',
  description:
  ...
  openGraph: {
    title: 'Michigan Real Estate Exam Guide — Everything You Need to Know',
    description:
