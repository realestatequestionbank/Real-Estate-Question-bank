...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How old do you have to be to get a real estate license in Michigan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You must be at least 18 years old to apply for a real estate salesperson license in Michigan.',
      },
    },
    {
      '@type': 'Question',
      name: 'How many questions are on the Michigan real estate licensing exam?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The Michigan real estate licensing exam typically consists of a national section and a state-specific section, totaling between 100 to 150 multiple-choice questions depending on state regulatory formats.',
      },
    },
    {
      '@type': 'Question',
      name: 'What regulatory body issues real estate licenses in Michigan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Real estate licenses in Michigan are issued by the Michigan Department of Licensing and Regulatory Affairs (LARA). You can visit their official portal for registration and forms.',
      },
    },
    {
      '@type': 'Question',
