...
export const metadata: Metadata = {
  title: 'Missouri Real Estate Exam Guide 2026 — Eligibility, Fees & Rules | Real Estate Question Bank',
  description:
  ...
  openGraph: {
    title: 'Missouri Real Estate Exam Guide — Everything You Need to Know',
    description:
