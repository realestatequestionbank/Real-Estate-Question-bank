...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Kansas real estate licensing requirements',
    'Kansas real estate salesperson exam',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Kansas Real Estate Exam Guide',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Kansas Real Estate Exam Guide',
    description:
      'Everything you need to know about preparing for and passing your Kansas Real Estate salesperson licensing exam.',
