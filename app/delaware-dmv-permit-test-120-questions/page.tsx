...
export const metadata: Metadata = {
    title: `FREE Delaware Real Estate Real Estate Practice Test 2026 — 120 Questions | Real Estate Question Bank`,
    description: 'Free 120-question Delaware Real Estate practice test. Matches the official exam format. Need 96/120 correct to pass (80%). Updated for 2026.',
    keywords: [
        'delaware real-estate practice test 120 questions',
    ...
    openGraph: {
        title: `FREE Delaware Real Estate Real Estate Practice Test 2026 — 120 Questions`,
        description: 'Free 120-question Delaware Real Estate practice test. Matches the official exam format. Need 96/120 correct to pass (80%). Updated for 2026.',
        type: 'website',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Delaware Real Estate Real Estate Practice Test 120 Questions'
            }
        ]
    },
    twitter: {
        card: 'summary_large_image',
        title: `Delaware Real Estate Real Estate Practice Test 2026 — 120 Questions`,
        description: 'Free 120-question Delaware Real Estate practice test. Matches the official exam format. Need 96/120 correct to pass (80%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Delaware Real Estate Real Estate Practice Test 2026 — 120 Questions, Answers & Explanations",
    "description": "Take a free 120-question Delaware Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
    "author": {
        "@type": "Organization",
