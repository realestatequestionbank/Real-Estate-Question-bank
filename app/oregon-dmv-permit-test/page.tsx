...
// State configuration
const STATE_KEY = 'oregon' as const
const STATE_NAME = 'Oregon'
const STATE_CODE = 'OR'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, oregonStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: oregonStateData.seo,
  pricing: oregonStateData.pricing,
  faq: oregonStateData.faq,
  lastUpdated: oregonStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(oregonStateData.faq)
...
export default function OregonPermitTestPage() {
  return (
    <>
