            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
              ...
              <div className="text-left lg:-mt-12">
                ...
                <p className="text-base text-gray-600 mb-3 md:mb-4 lg:mb-5 max-w-2xl lg:max-w-none animate-fade-in-up delay-200">
                  Imagine you are at the Real Estate and you know you will pass because you have already seen every question before. Join 100K+ students using our state-specific California Real Estate question bank and pass on your first attempt.
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory pb-6 -mx-4 px-4 gap-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6 md:overflow-visible md:pb-0 md:mx-0 md:px-0 scrollbar-hide">
              ...
              {/* Driver's Handbook */}
              <a
                href="https://www.real-estate.ca.gov/portal/handbook/california-driver-handbook/"
                target="_blank"
                rel="noopener noreferrer"
                className="snap-center flex-shrink-0 w-[70vw] md:w-auto bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 group"
              >
            ...
            <div className="text-center mt-8 md:mt-12">
              <p className="text-xs md:text-sm text-gray-500">
                These are official <a href="https://www.real-estate.ca.gov/portal/" target="_blank" rel="noopener noreferrer" className="text-[#007aff] underline decoration-transparent hover:decoration-[#007aff] underline-offset-2 transition-all duration-300">California Department of Motor Vehicles</a> resources. Real Estate Question Bank is not affiliated with the California Real Estate.
              </p>
            </div>
          </div>
        </div>
