...
export const metadata: Metadata = {
    title: `FREE Illinois SOS Real Estate Practice Test 2026 — 140 Questions | Real Estate Question Bank`,
    description: 'Free 140-question Illinois Real Estate practice test. Matches the official exam format. Need 105/140 correct to pass (75%). Updated for 2026.',
    keywords: [
        'illinois real-estate practice test 140 questions',
    ...
    openGraph: {
        title: `FREE Illinois SOS Real Estate Practice Test 2026 — 140 Questions`,
        description: 'Free 140-question Illinois Real Estate practice test. Matches the official exam format. Need 105/140 correct to pass (75%). Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'Illinois SOS Real Estate Practice Test 140 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `Illinois SOS Real Estate Practice Test 2026 — 140 Questions`,
        description: 'Free 140-question Illinois Real Estate practice test. Matches the official exam format. Need 105/140 correct to pass (75%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Illinois SOS Real Estate Practice Test 2026 — 140 Questions, Answers & Explanations",
    "description": "Take a free 140-question Illinois Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
