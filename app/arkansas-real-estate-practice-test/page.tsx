...
// State configuration
const STATE_KEY = 'arkansas' as const
const STATE_NAME = 'Arkansas'
const STATE_CODE = 'AR'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, arkansasStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: arkansasStateData.seo,
  pricing: arkansasStateData.pricing,
  faq: arkansasStateData.faq,
  lastUpdated: arkansasStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(arkansasStateData.faq)
...
export default function ArkansasPermitTestPage() {
  return (
    <>
