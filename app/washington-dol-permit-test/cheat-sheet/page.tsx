...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://www.realestatequestionbank.com/washington-dol-permit-test/cheat-sheet',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://www.realestatequestionbank.com/washington-dol-permit-test/cheat-sheet'
  }
}
