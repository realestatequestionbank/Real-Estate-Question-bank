...
// State configuration
const STATE_KEY = 'mississippi' as const
const STATE_NAME = 'Mississippi'
const STATE_CODE = 'MS'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, mississippiStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: mississippiStateData.seo,
  pricing: mississippiStateData.pricing,
  faq: mississippiStateData.faq,
  lastUpdated: mississippiStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(mississippiStateData.faq)
...
export default function MississippiPermitTestPage() {
  return (
    <>
