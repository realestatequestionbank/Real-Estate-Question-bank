...
// State configuration
const STATE_KEY = 'illinois' as const
const STATE_NAME = 'Illinois'
const STATE_CODE = 'IL'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, illinoisStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: illinoisStateData.seo,
  pricing: illinoisStateData.pricing,
  faq: illinoisStateData.faq,
  lastUpdated: illinoisStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(illinoisStateData.faq)
