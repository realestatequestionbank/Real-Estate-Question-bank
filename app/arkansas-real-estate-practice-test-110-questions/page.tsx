...
export const metadata: Metadata = {
    title: `FREE Arkansas DFA Real Estate Practice Test 2026 — 110 Questions | Real Estate Question Bank`,
    description: 'Free 110-question Arkansas Real Estate practice test. Matches the official exam format. Need 77/110 correct to pass (70%). Updated for 2026.',
    keywords: [
        'arkansas real-estate practice test 110 questions',
    ...
    openGraph: {
        title: `FREE Arkansas DFA Real Estate Practice Test 2026 — 110 Questions`,
        description: 'Free 110-question Arkansas Real Estate practice test. Matches the official exam format. Need 77/110 correct to pass (70%). Updated for 2026.',
        type: 'website',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Arkansas DFA Real Estate Practice Test 110 Questions'
            }
        ]
    },
    twitter: {
        card: 'summary_large_image',
        title: `Arkansas DFA Real Estate Practice Test 2026 — 110 Questions`,
        description: 'Free 110-question Arkansas Real Estate practice test. Matches the official exam format. Need 77/110 correct to pass (70%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Arkansas DFA Real Estate Practice Test 2026 — 110 Questions, Answers & Explanations",
    "description": "Take a free 110-question Arkansas Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
    "author": {
        "@type": "Organization",
