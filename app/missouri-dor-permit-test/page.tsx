...
// State configuration
const STATE_KEY = 'missouri' as const
const STATE_NAME = 'Missouri'
const STATE_CODE = 'MO'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, missouriStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: missouriStateData.seo,
  pricing: missouriStateData.pricing,
  faq: missouriStateData.faq,
  lastUpdated: missouriStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(missouriStateData.faq)
...
export default function MissouriPermitTestPage() {
  return (
    <>
