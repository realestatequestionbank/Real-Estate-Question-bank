...
// State configuration
const STATE_KEY = 'idaho' as const
const STATE_NAME = 'Idaho'
const STATE_CODE = 'ID'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, idahoStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: idahoStateData.seo,
  pricing: idahoStateData.pricing,
  faq: idahoStateData.faq,
  lastUpdated: idahoStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(idahoStateData.faq)
...
export default function IdahoPermitTestPage() {
  return (
    <>
