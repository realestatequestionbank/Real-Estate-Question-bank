...
// State configuration
const STATE_KEY = 'vermont' as const
const STATE_NAME = 'Vermont'
const STATE_CODE = 'VT'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, vermontStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: vermontStateData.seo,
  pricing: vermontStateData.pricing,
  faq: vermontStateData.faq,
  lastUpdated: vermontStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(vermontStateData.faq)
...
export default function VermontPermitTestPage() {
  return (
    <>
