...
// State configuration
const STATE_KEY = 'virginia' as const
const STATE_NAME = 'Virginia'
const STATE_CODE = 'VA'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, virginiaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: virginiaStateData.seo,
  pricing: virginiaStateData.pricing,
  faq: virginiaStateData.faq,
  lastUpdated: virginiaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(virginiaStateData.faq)
...
export default function VirginiaPermitTestPage() {
  return (
    <>
