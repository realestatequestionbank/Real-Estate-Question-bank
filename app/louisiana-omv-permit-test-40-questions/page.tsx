...
export const metadata: Metadata = {
    title: `FREE Louisiana OMV Real Estate Practice Test 2026 — 40 Questions | Real Estate Question Bank`,
    description: 'Take a free 40-question Louisiana Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
    keywords: [
        'louisiana real-estate practice test 40 questions',
    ...
    openGraph: {
        title: `FREE Louisiana OMV Real Estate Practice Test 2026 — 40 Questions`,
        description: 'Take a free 40-question Louisiana Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'Louisiana OMV Real Estate Practice Test 40 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `Louisiana OMV Real Estate Practice Test 2026 — 40 Questions`,
        description: 'Take a free 40-question Louisiana Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Louisiana OMV Real Estate Practice Test 2026 — 40 Questions, Answers & Explanations",
    "description": "Take a free 40-question Louisiana Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
