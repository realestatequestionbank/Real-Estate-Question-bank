...
export const metadata: Metadata = {
    title: `FREE Missouri DOR Real Estate Practice Test 2026 — 140 Questions | Real Estate Question Bank`,
    description: 'Free 140-question Missouri Real Estate practice test. Matches the official exam format. Need 98/140 correct to pass (70%). Updated for 2026.',
    keywords: [
        'missouri real-estate practice test 140 questions',
    ...
    openGraph: {
        title: `FREE Missouri DOR Real Estate Practice Test 2026 — 140 Questions`,
        description: 'Free 140-question Missouri Real Estate practice test. Matches the official exam format. Need 98/140 correct to pass (70%). Updated for 2026.',
        type: 'website',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Missouri DOR Real Estate Practice Test 140 Questions'
            }
        ]
    },
    twitter: {
        card: 'summary_large_image',
        title: `Missouri DOR Real Estate Practice Test 2026 — 140 Questions`,
        description: 'Free 140-question Missouri Real Estate practice test. Matches the official exam format. Need 98/140 correct to pass (70%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Missouri DOR Real Estate Practice Test 2026 — 140 Questions, Answers & Explanations",
    "description": "Take a free 140-question Missouri Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
    "author": {
        "@type": "Organization",
