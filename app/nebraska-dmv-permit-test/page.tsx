...
// State configuration
const STATE_KEY = 'nebraska' as const
const STATE_NAME = 'Nebraska'
const STATE_CODE = 'NE'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, nebraskaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: nebraskaStateData.seo,
  pricing: nebraskaStateData.pricing,
  faq: nebraskaStateData.faq,
  lastUpdated: nebraskaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(nebraskaStateData.faq)
...
export default function NebraskaPermitTestPage() {
  return (
    <>
