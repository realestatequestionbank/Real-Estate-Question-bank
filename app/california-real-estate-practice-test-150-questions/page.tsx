...
export const metadata: Metadata = {
    title: `FREE California Real Estate Real Estate Practice Test 2026 — 150 Questions | Real Estate Question Bank`,
    description: 'Free 150-question California Real Estate practice test. Matches the official exam format. Need 105/150 correct to pass (70%). Updated for 2026.',
    keywords: [
        'california real-estate practice test 150 questions',
    ...
    openGraph: {
        title: `FREE California Real Estate Real Estate Practice Test 2026 — 150 Questions`,
        description: 'Free 150-question California Real Estate practice test. Matches the official exam format. Need 105/150 correct to pass (70%). Updated for 2026.',
        type: 'website',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'California Real Estate Real Estate Practice Test 150 Questions'
            }
        ]
    },
    twitter: {
        card: 'summary_large_image',
        title: `California Real Estate Real Estate Practice Test 2026 — 150 Questions`,
        description: 'Free 150-question California Real Estate practice test. Matches the official exam format. Need 105/150 correct to pass (70%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "California Real Estate Real Estate Practice Test 2026 — 150 Questions, Answers & Explanations",
    "description": "Take a free 150-question California Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
    "author": {
        "@type": "Organization",
