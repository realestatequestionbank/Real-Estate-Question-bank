...
export const metadata: Metadata = {
    title: `FREE Minnesota DVS Real Estate Practice Test 2026 — 130 Questions | Real Estate Question Bank`,
    description: 'Free 130-question Minnesota Real Estate practice test. Matches the official exam format. Need 97/130 correct to pass (75%). Updated for 2026.',
    keywords: [
        'minnesota real-estate practice test 130 questions',
    ...
    openGraph: {
        title: `FREE Minnesota DVS Real Estate Practice Test 2026 — 130 Questions`,
        description: 'Free 130-question Minnesota Real Estate practice test. Matches the official exam format. Need 97/130 correct to pass (75%). Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'Minnesota DVS Real Estate Practice Test 130 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `Minnesota DVS Real Estate Practice Test 2026 — 130 Questions`,
        description: 'Free 130-question Minnesota Real Estate practice test. Matches the official exam format. Need 97/130 correct to pass (75%). Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Minnesota DVS Real Estate Practice Test 2026 — 130 Questions, Answers & Explanations",
    "description": "Take a free 130-question Minnesota Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
