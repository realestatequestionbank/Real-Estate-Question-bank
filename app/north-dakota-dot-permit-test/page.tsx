...
// State configuration
const STATE_KEY = 'north-dakota' as const
const STATE_NAME = 'North Dakota'
const STATE_CODE = 'ND'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, northdakotaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: northdakotaStateData.seo,
  pricing: northdakotaStateData.pricing,
  faq: northdakotaStateData.faq,
  lastUpdated: northdakotaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(northdakotaStateData.faq)
...
export default function NorthDakotaPermitTestPage() {
  return (
    <>
