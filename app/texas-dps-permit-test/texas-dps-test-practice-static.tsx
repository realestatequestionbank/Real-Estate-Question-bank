              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start mb-8 md:mb-12 lg:mb-16 animate-fade-in-up">
                ...
                <div className="bg-[#007aff]/5 rounded-lg p-5 border border-[#007aff]/10 flex flex-col justify-center w-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <Link
                      href="/texas-real-estate-practice-test-30-questions"
                      className="flex items-center text-sm font-semibold text-gray-900 hover:text-[#007aff] transition-all duration-200 group"
                    >
                      <div className="w-8 h-8 rounded-lg bg-[#007aff]/10 flex items-center justify-center mr-3 text-[#007aff] group-hover:scale-105 transition-transform flex-shrink-0">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 rounded-3xl p-6 md:p-8 lg:p-12 shadow-lg border border-green-100 mb-8 md:mb-12 lg:mb-16 animate-fade-in-up delay-150">
                <div className="text-center max-w-3xl mx-auto">
                  ...
                  {/* Download Button */}
                  <Button
                    onClick={() => window.open('/free-permit-test-questions-PDF/Free-Texas-Real Estate-Practice-Questions.pdf', '_blank')}
                    size="lg"
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8 md:mb-12 animate-fade-in-up">
                ...
                <p className="text-xs md:text-sm lg:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Questions are manually curated by the Real Estate Question Bank content team using the <Link href="/handbooks/texas" className="font-medium text-[#007aff] underline decoration-transparent hover:decoration-[#007aff] underline-offset-4 transition-all duration-300">Texas Real Estate Handbook (2026)</Link>. Each page in the Real Estate handbook is mapped to real real estate exam questions – so you practice with questions that closely mirror the actual Real Estate Exam.
                </p>
              </div>
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Matches the real TX Real Estate Exam — 46 questions, need 38 to pass (83%)</p>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-sm md:text-base lg:text-lg xl:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Access official Texas Real Estate websites for additional information, services, and test preparation materials.
              </p>
            </div>
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory pb-6 -mx-4 px-4 gap-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6 md:overflow-visible md:pb-0 md:mx-0 md:px-0 scrollbar-hide">
              ...
              {/* Candidate Handbook */}
              <a
                href="https://home.pearsonvue.com/tx/realestate"
                target="_blank"
                rel="noopener noreferrer"
                className="snap-center flex-shrink-0 w-[70vw] md:w-auto bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 group"
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Official exam candidate handbook, guidelines, and outline
                </p>
              </a>

              {/* Educational Materials */}
              <a
                href="https://www.trec.texas.gov/become-licensed/salesperson"
                target="_blank"
                rel="noopener noreferrer"
                className="snap-center flex-shrink-0 w-[70vw] md:w-auto bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 group"
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Official pre-licensing education requirements and steps
                </p>
              </a>

              {/* Online Services */}
              <a
                href="https://www.trec.texas.gov/my-license"
                target="_blank"
                rel="noopener noreferrer"
                className="snap-center flex-shrink-0 w-[70vw] md:w-auto bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 group"
              >
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Manage applications, check licensing status, and renew online
                </p>
              </a>
            </div>
            ...
            <div className="text-center mt-8 md:mt-12">
              <p className="text-xs md:text-sm text-gray-500">
                These are official <a href="https://www.trec.texas.gov/" target="_blank" rel="noopener noreferrer" className="text-[#007aff] underline decoration-transparent hover:decoration-[#007aff] underline-offset-2 transition-all duration-300">Texas Real Estate Commission (TREC)</a> resources. Real Estate Question Bank is not affiliated with the TREC.
              </p>
            </div>
          </div>
        </div>
