...
export const metadata: Metadata = {
    title: `FREE Michigan SOS Real Estate Practice Test 2026 — 40 Questions | Real Estate Question Bank`,
    description: 'Take a free 40-question Michigan Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
    keywords: [
        'michigan real-estate practice test 40 questions',
    ...
    openGraph: {
        title: `FREE Michigan SOS Real Estate Practice Test 2026 — 40 Questions`,
        description: 'Take a free 40-question Michigan Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'Michigan SOS Real Estate Practice Test 40 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `Michigan SOS Real Estate Practice Test 2026 — 40 Questions`,
        description: 'Take a free 40-question Michigan Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Michigan SOS Real Estate Practice Test 2026 — 40 Questions, Answers & Explanations",
    "description": "Take a free 40-question Michigan Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
