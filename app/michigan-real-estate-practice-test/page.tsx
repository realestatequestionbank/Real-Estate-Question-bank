...
// State configuration
const STATE_KEY = 'michigan' as const
const STATE_NAME = 'Michigan'
const STATE_CODE = 'MI'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, michiganStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: michiganStateData.seo,
  pricing: michiganStateData.pricing,
  faq: michiganStateData.faq,
  lastUpdated: michiganStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(michiganStateData.faq)
...
export default function MichiganPermitTestPage() {
  return (
    <>
