...
export const metadata: Metadata = {
    title: `FREE Virginia Real Estate Real Estate Practice Test 2026 — 36 Questions | Real Estate Question Bank`,
    description: 'Take a free 36-question Virginia Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
    keywords: [
        'virginia real-estate practice test 36 questions',
    ...
    openGraph: {
        title: `FREE Virginia Real Estate Real Estate Practice Test 2026 — 36 Questions`,
        description: 'Take a free 36-question Virginia Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
        type: 'website',
        url: `https://www.realestatequestionbank.com/${config.pageUrl}`,
        siteName: 'Real Estate Question Bank',
        images: [{ url: '/images/cover-image.png', width: 1200, height: 630, alt: 'Virginia Real Estate Real Estate Practice Test 36 Questions' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: `Virginia Real Estate Real Estate Practice Test 2026 — 36 Questions`,
        description: 'Take a free 36-question Virginia Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math. Updated for 2026.',
...
const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Virginia Real Estate Real Estate Practice Test 2026 — 36 Questions, Answers & Explanations",
    "description": "Take a free 36-question Virginia Real Estate practice test matching the real format. Covers real estate principles, licensing laws, contracts, agency disclosures, and property math.",
