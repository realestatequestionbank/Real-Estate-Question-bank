...
// State configuration
const STATE_KEY = 'alabama' as const
const STATE_NAME = 'Alabama'
const STATE_CODE = 'AL'

// Generate page data using the helper
const pageData = generateStatePageDataSync(STATE_KEY, alabamaStateData)
...
export const metadata: Metadata = generateStateMetadata({
  ...
  seo: alabamaStateData.seo,
  pricing: alabamaStateData.pricing,
  faq: alabamaStateData.faq,
  lastUpdated: alabamaStateData.lastUpdated,
})

// Generate structured data schemas
const faqSchema = generateFaqSchema(alabamaStateData.faq)
...
export default function AlabamaPermitTestPage() {
  return (
    <>
