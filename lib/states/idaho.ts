export const idahoStateData = {
  ...
  seo: {
    title: 'FREE Idaho Real Estate Exam Practice 2026 | Real Estate Question Bank',
    description: 'Pass your Idaho Real Estate Exam on the first try with our comprehensive practice questions. Updated for 2026 with real exam style questions and detailed explanations.',
    keywords: [
      'Idaho real estate exam',
      'Idaho real estate practice test',
      'Idaho real estate license exam prep',
      'Idaho Real Estate Commission (IREC) licensing test',
      'how to pass real estate exam in Idaho'
    ]
  },
  testOverview: {
    totalQuestions: 130,
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Yes, if you do not pass the exam on your first attempt, you can apply to retake it. The retake policy in Idaho allows: Can schedule a retake of the failed portion immediately. You will need to submit a re-examination application and pay the required fee again. While you can re-apply immediately, scheduling availability depends on current testing center volumes, which can sometimes lead to wait times of several weeks between attempts, making it crucial to pass on your first try.'
    },
    {
      question: 'What topics are covered on the Idaho Real Estate Exam?',
