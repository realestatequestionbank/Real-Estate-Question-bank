export const indianaStateData = {
  ...
  seo: {
    title: 'FREE Indiana Real Estate Exam Practice 2026 | Real Estate Question Bank',
    description: 'Pass your Indiana Real Estate Exam on the first try with our comprehensive practice questions. Updated for 2026 with real exam style questions and detailed explanations.',
    keywords: [
      'Indiana real estate exam',
      'Indiana real estate practice test',
      'Indiana real estate license exam prep',
      'Indiana Real Estate Commission licensing test',
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Yes, if you do not pass the exam on your first attempt, you can apply to retake it. The retake policy in Indiana allows: Can schedule a retake of the failed portion immediately. You will need to submit a re-examination application and pay the required fee again. While you can re-apply immediately, scheduling availability depends on current testing center volumes, which can sometimes lead to wait times of several weeks between attempts, making it crucial to pass on your first try.'
    },
    {
      question: 'What topics are covered on the Indiana Real Estate Exam?',
    ...
    {
      question: 'What is the difference between a Real Estate Salesperson and a Broker in Indiana?',
      answer: 'A Real Estate Salesperson is licensed to perform real estate transactions under the supervision of a licensed broker. A Salesperson cannot operate independently. A Real Estate Broker, on the other hand, can run their own independent firm, hire sales agents, and manage transactions directly. Becoming a broker in Indiana requires additional years of active experience as a salesperson and completing advanced coursework before passing the broker exam.'
    },
    {
