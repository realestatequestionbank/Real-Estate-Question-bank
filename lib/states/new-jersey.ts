export const newjerseyStateData = {
  ...
  seo: {
    title: 'FREE New Jersey Real Estate Exam Practice 2026 | Real Estate Question Bank',
    description: 'Pass your New Jersey Real Estate Exam on the first try with our comprehensive practice questions. Updated for 2026 with real exam style questions and detailed explanations.',
    keywords: [
      'New Jersey real estate exam',
      'New Jersey real estate practice test',
      'New Jersey real estate license exam prep',
      'New Jersey Real Estate Commission licensing test',
      'how to pass real estate exam in New Jersey'
    ]
  },
  testOverview: {
    totalQuestions: 110,
