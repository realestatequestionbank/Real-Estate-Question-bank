  ...
  faq: [
    {
      ...
      answer: 'The official Delaware real estate salesperson licensing exam consists of 120 multiple-choice questions in total. You are given exactly 4 Hours to complete the test. To pass the exam and qualify for your license, you must score at least 80%—which translates to answering at least 96 questions correctly. There is no penalty for guessing, so it is highly recommended to answer every question on the test.'
    },
    {
