export const michiganStateData = {
  stateName: 'Michigan',
  pricing: {
    freeQuestions: 20,
  ...
  seo: {
    title: 'FREE Michigan Real Estate Exam Practice 2026 | Real Estate Question Bank',
    description: 'Pass your Michigan Real Estate Exam on the first try with our comprehensive practice questions. Updated for 2026 with real exam style questions and detailed explanations.',
    keywords: [
      'Michigan real estate exam',
      'Michigan real estate practice test',
      'Michigan real estate license exam prep',
      'Michigan Department of Licensing and Regulatory Affairs (LARA) licensing test',
