export const maineStateData = {
  ...
  seo: {
    title: 'FREE Maine Real Estate Exam Practice 2026 | Real Estate Question Bank',
    description: 'Pass your Maine Real Estate Exam on the first try with our comprehensive practice questions. Updated for 2026 with real exam style questions and detailed explanations.',
    keywords: [
      'Maine real estate exam',
      'Maine real estate practice test',
      'Maine real estate license exam prep',
      'Maine Real Estate Commission licensing test',
      'how to pass real estate exam in Maine'
    ]
  },
  testOverview: {
    totalQuestions: 120,
    ...
    ageRequirements: {
      ...
      over18: 'Eligible immediately after completing 55 hours of pre-licensing education.'
    },
    topicsCovered: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Yes, if you do not pass the exam on your first attempt, you can apply to retake it. The retake policy in Maine allows: Can schedule a retake of the failed portion immediately. You will need to submit a re-examination application and pay the required fee again. While you can re-apply immediately, scheduling availability depends on current testing center volumes, which can sometimes lead to wait times of several weeks between attempts, making it crucial to pass on your first try.'
    },
    {
      question: 'What topics are covered on the Maine Real Estate Exam?',
