export const virginiaStateData = {
  stateName: 'Virginia',
  pricing: {
    freeQuestions: 20,
  ...
  seo: {
    title: 'FREE Virginia Real Estate Exam Practice 2026 | Real Estate Question Bank',
    description: 'Pass your Virginia Real Estate Exam on the first try with our comprehensive practice questions. Updated for 2026 with real exam style questions and detailed explanations.',
    keywords: [
      'Virginia real estate exam',
      'Virginia real estate practice test',
      'Virginia real estate license exam prep',
      'Virginia Real Estate Board licensing test',
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'The exam covers major content areas defined by the VREB, which typically include:<ul class="list-disc pl-6 mt-3 mb-3 space-y-2 text-gray-700"><li>Real Estate Principles and Practices</li><li>Real Estate Law and Contracts</li><li>Agency Relationships and Disclosures</li><li>Property Valuation and Financial Math</li><li>Financing</li><li>Mortgages</li><li>Escrow</li><li>State-Specific Licensing Laws and Commission Rules</li></ul><br/><br/>Fiduciary duties, contract law, and agency disclosures represent some of the most heavily weighted categories on the exam.'
    },
    {
