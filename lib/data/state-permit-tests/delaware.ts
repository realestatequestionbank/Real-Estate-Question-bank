...
export const delawarePermitTestConfig: StatePermitTestConfig = {
    stateName: 'Delaware',
    stateCode: 'DE',
    departmentName: 'Delaware Real Estate Commission',
    departmentAbbr: 'DREC',
    ...
    mainPageUrl: '/delaware-real-estate-practice-test',
    pageUrl: '/delaware-real-estate-practice-test-120-questions',
...
export const delawarePermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Delaware Real Estate Exam?",
        answer: "The real Delaware Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Delaware real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Delaware Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Delaware Real Estate Exam?",
