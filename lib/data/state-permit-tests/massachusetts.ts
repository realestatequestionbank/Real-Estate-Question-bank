...
export const massachusettsPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'MA',
    departmentName: 'Massachusetts Real Estate Board',
    departmentAbbr: 'MREC',
    ...
    mainPageUrl: '/massachusetts-real-estate-practice-test',
    pageUrl: '/massachusetts-real-estate-practice-test-120-questions',
...
export const massachusettsPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Massachusetts Real Estate Exam?",
        answer: "The real Massachusetts Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Massachusetts real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Massachusetts Real Estate Board guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Massachusetts Real Estate Exam?",
