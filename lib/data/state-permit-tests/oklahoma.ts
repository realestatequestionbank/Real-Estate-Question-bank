...
export const oklahomaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Oklahoma',
    stateCode: 'OK',
    departmentName: 'Oklahoma Real Estate Commission',
    departmentAbbr: 'OREC',
    realQuestionCount: 130,
    realPassCount: 97,
    passPercent: 75,
    timeLimit: '3 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/oklahoma-real-estate-practice-test',
    pageUrl: '/oklahoma-real-estate-practice-test-130-questions',
    stateGuideUrl: '/state-guides/oklahoma',
    handbookUrl: '',
    year: 2026,
}
...
export const oklahomaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Oklahoma Real Estate Exam?",
        answer: "The real Oklahoma Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Oklahoma real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Oklahoma Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Oklahoma Real Estate Exam?",
