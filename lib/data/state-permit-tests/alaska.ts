...
export const alaskaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Alaska',
    stateCode: 'AK',
    departmentName: 'Alaska Real Estate Commission',
    departmentAbbr: 'AREC',
    ...
    mainPageUrl: '/alaska-real-estate-practice-test',
    pageUrl: '/alaska-real-estate-practice-test-120-questions',
...
export const alaskaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Alaska Real Estate Exam?",
        answer: "The real Alaska Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Alaska real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Alaska Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Alaska Real Estate Exam?",
