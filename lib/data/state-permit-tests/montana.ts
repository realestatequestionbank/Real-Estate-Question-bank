...
export const montanaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Montana',
    stateCode: 'MT',
    departmentName: 'Montana Board of Realty Regulation',
    departmentAbbr: 'MBRR',
    realQuestionCount: 113,
    realPassCount: 79,
    passPercent: 70,
    timeLimit: '3 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/montana-real-estate-practice-test',
    pageUrl: '/montana-real-estate-practice-test-113-questions',
...
export const montanaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Montana Real Estate Exam?",
        answer: "The real Montana Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Montana real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Montana Board of Realty Regulation guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Montana Real Estate Exam?",
