...
export const wyomingPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Wyoming',
    stateCode: 'WY',
    departmentName: 'Wyoming Real Estate Commission',
    departmentAbbr: 'WREC',
...
export const wyomingPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Wyoming Real Estate Exam?",
        answer: "The real Wyoming Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Wyoming real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Wyoming Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Wyoming Real Estate Exam?",
