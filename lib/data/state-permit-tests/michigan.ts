...
export const michiganPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Michigan',
    stateCode: 'MI',
    departmentName: 'Michigan Licensing and Regulatory Affairs',
    departmentAbbr: 'LARA',
    realQuestionCount: 115,
    realPassCount: 80,
    passPercent: 70,
    timeLimit: '3 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/michigan-real-estate-practice-test',
    pageUrl: '/michigan-real-estate-practice-test-115-questions',
...
export const michiganPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Michigan Real Estate Exam?",
        answer: "The real Michigan Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Michigan real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Michigan Licensing and Regulatory Affairs guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Michigan Real Estate Exam?",
