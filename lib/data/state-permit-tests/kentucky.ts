...
export const kentuckyPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Kentucky',
    stateCode: 'KY',
    departmentName: 'Kentucky Real Estate Commission',
    departmentAbbr: 'KREC',
    ...
    mainPageUrl: '/kentucky-real-estate-practice-test',
    pageUrl: '/kentucky-real-estate-practice-test-120-questions',
...
export const kentuckyPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Kentucky Real Estate Exam?",
        answer: "The real Kentucky Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Kentucky real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Kentucky Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Kentucky Real Estate Exam?",
