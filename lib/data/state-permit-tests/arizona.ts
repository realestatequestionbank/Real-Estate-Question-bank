...
export const arizonaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Arizona',
    stateCode: 'AZ',
    departmentName: 'Arizona Department of Real Estate',
    departmentAbbr: 'ADRE',
    realQuestionCount: 180,
    realPassCount: 135,
    passPercent: 75,
    timeLimit: '5 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/arizona-real-estate-practice-test',
    pageUrl: '/arizona-real-estate-practice-test-180-questions',
...
export const arizonaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Arizona Real Estate Exam?",
        answer: "The real Arizona Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Arizona real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Arizona Department of Real Estate guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Arizona Real Estate Exam?",
