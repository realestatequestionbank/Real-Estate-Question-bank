...
export const texasPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Texas',
    stateCode: 'TX',
    departmentName: 'Texas Real Estate Commission',
    departmentAbbr: 'TREC',
    realQuestionCount: 125,
    realPassCount: 88,
    passPercent: 70,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/texas-real-estate-practice-test',
    pageUrl: '/texas-real-estate-practice-test-125-questions',
...
export const texasPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Texas Real Estate Exam?",
        answer: "The real Texas Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Texas real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Texas Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Texas Real Estate Exam?",
