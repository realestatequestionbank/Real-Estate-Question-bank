...
export const rhodeIslandPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'RI',
    departmentName: 'Rhode Island Department of Business Regulation',
    departmentAbbr: 'DBR',
    ...
    mainPageUrl: '/rhode-island-real-estate-practice-test',
    pageUrl: '/rhode-island-real-estate-practice-test-120-questions',
...
export const rhodeIslandPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Rhode Island Real Estate Exam?",
        answer: "The real Rhode Island Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Rhode Island real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Rhode Island Department of Business Regulation guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Rhode Island Real Estate Exam?",
