...
export const utahPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Utah',
    stateCode: 'UT',
    departmentName: 'Utah Division of Real Estate',
    departmentAbbr: 'UDRE',
    ...
    mainPageUrl: '/utah-real-estate-practice-test',
    pageUrl: '/utah-real-estate-practice-test-120-questions',
...
export const utahPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Utah Real Estate Exam?",
        answer: "The real Utah Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Utah real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Utah Division of Real Estate guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Utah Real Estate Exam?",
