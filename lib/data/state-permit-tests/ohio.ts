...
export const ohioPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Ohio',
    stateCode: 'OH',
    departmentName: 'Ohio Division of Real Estate',
    departmentAbbr: 'ODRE',
    ...
    mainPageUrl: '/ohio-real-estate-practice-test',
    pageUrl: '/ohio-real-estate-practice-test-120-questions',
...
export const ohioPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Ohio Real Estate Exam?",
        answer: "The real Ohio Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Ohio real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Ohio Division of Real Estate guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Ohio Real Estate Exam?",
