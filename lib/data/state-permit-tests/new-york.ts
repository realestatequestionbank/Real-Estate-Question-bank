...
export const newYorkPermitTestConfig: StatePermitTestConfig = {
    stateName: 'New York',
    stateCode: 'NY',
    departmentName: 'New York Department of State',
    departmentAbbr: 'NYDOS',
    realQuestionCount: 75,
    realPassCount: 53,
    passPercent: 70,
    timeLimit: '2 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/new-york-real-estate-practice-test',
    pageUrl: '/new-york-real-estate-practice-test-75-questions',
...
export const newYorkPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real New York Real Estate Exam?",
        answer: "The real New York Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the New York real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the New York Department of State guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the New York Real Estate Exam?",
