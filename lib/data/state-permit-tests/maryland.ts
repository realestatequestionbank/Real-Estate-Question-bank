...
export const marylandPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Maryland',
    stateCode: 'MD',
    departmentName: 'Maryland Real Estate Commission',
    departmentAbbr: 'MREC',
    ...
    mainPageUrl: '/maryland-real-estate-practice-test',
    pageUrl: '/maryland-real-estate-practice-test-110-questions',
...
export const marylandPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Maryland Real Estate Exam?",
        answer: "The real Maryland Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Maryland real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Maryland Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Maryland Real Estate Exam?",
