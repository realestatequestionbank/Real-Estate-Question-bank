...
export const mainePermitTestConfig: StatePermitTestConfig = {
    stateName: 'Maine',
    stateCode: 'ME',
    departmentName: 'Maine Real Estate Commission',
    departmentAbbr: 'MREC',
    ...
    mainPageUrl: '/maine-real-estate-practice-test',
    pageUrl: '/maine-real-estate-practice-test-120-questions',
...
export const mainePermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Maine Real Estate Exam?",
        answer: "The real Maine Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Maine real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Maine Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Maine Real Estate Exam?",
