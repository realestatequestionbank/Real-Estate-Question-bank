...
export const indianaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Indiana',
    stateCode: 'IN',
    departmentName: 'Indiana Real Estate Commission',
    departmentAbbr: 'IREC',
    ...
    mainPageUrl: '/indiana-real-estate-practice-test',
    pageUrl: '/indiana-real-estate-practice-test-130-questions',
...
export const indianaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Indiana Real Estate Exam?",
        answer: "The real Indiana Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Indiana real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Indiana Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Indiana Real Estate Exam?",
