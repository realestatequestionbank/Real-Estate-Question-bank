...
export const mississippiPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'MS',
    departmentName: 'Mississippi Real Estate Commission',
    departmentAbbr: 'MREC',
    realQuestionCount: 120,
    realPassCount: 90,
    passPercent: 75,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/mississippi-real-estate-practice-test',
    pageUrl: '/mississippi-real-estate-practice-test-120-questions',
    stateGuideUrl: '/state-guides/mississippi',
    handbookUrl: '',
    year: 2026,
}
...
export const mississippiPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Mississippi Real Estate Exam?",
        answer: "The real Mississippi Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Mississippi real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Mississippi Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Mississippi Real Estate Exam?",
