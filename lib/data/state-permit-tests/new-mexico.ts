...
export const newMexicoPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'NM',
    departmentName: 'New Mexico Real Estate Commission',
    departmentAbbr: 'NMREC',
    realQuestionCount: 120,
    realPassCount: 90,
    passPercent: 75,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/new-mexico-real-estate-practice-test',
    pageUrl: '/new-mexico-real-estate-practice-test-120-questions',
...
export const newMexicoPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real New Mexico Real Estate Exam?",
        answer: "The real New Mexico Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the New Mexico real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the New Mexico Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the New Mexico Real Estate Exam?",
