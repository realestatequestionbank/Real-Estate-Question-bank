...
export const iowaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Iowa',
    stateCode: 'IA',
    departmentName: 'Iowa Real Estate Commission',
    departmentAbbr: 'IREC',
    ...
    mainPageUrl: '/iowa-real-estate-practice-test',
    pageUrl: '/iowa-real-estate-practice-test-120-questions',
...
export const iowaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Iowa Real Estate Exam?",
        answer: "The real Iowa Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Iowa real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Iowa Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Iowa Real Estate Exam?",
