...
export const westVirginiaPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'WV',
    departmentName: 'West Virginia Real Estate Commission',
    departmentAbbr: 'WVREC',
    realQuestionCount: 150,
    realPassCount: 112,
    passPercent: 75,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/west-virginia-real-estate-practice-test',
    pageUrl: '/west-virginia-real-estate-practice-test-150-questions',
...
export const westVirginiaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real West Virginia Real Estate Exam?",
        answer: "The real West Virginia Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the West Virginia real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the West Virginia Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the West Virginia Real Estate Exam?",
