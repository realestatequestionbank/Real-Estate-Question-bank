...
export const coloradoPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Colorado',
    stateCode: 'CO',
    departmentName: 'Colorado Real Estate Commission',
    departmentAbbr: 'CREC',
    ...
    mainPageUrl: '/colorado-real-estate-practice-test',
    pageUrl: '/colorado-real-estate-practice-test-120-questions',
...
export const coloradoPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Colorado Real Estate Exam?",
        answer: "The real Colorado Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Colorado real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Colorado Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Colorado Real Estate Exam?",
