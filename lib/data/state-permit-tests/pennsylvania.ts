...
export const pennsylvaniaPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'PA',
    departmentName: 'Pennsylvania State Real Estate Commission',
    departmentAbbr: 'SREC',
    ...
    mainPageUrl: '/pennsylvania-real-estate-practice-test',
    pageUrl: '/pennsylvania-real-estate-practice-test-120-questions',
...
export const pennsylvaniaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Pennsylvania Real Estate Exam?",
        answer: "The real Pennsylvania Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Pennsylvania real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Pennsylvania State Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Pennsylvania Real Estate Exam?",
