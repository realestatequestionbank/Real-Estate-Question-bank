...
export const floridaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Florida',
    stateCode: 'FL',
    departmentName: 'Florida Real Estate Commission',
    departmentAbbr: 'FREC',
    ...
    mainPageUrl: '/florida-real-estate-practice-test',
    pageUrl: '/florida-real-estate-practice-test-100-questions',
...
export const floridaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Florida Real Estate Exam?",
        answer: "The real Florida Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Florida real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Florida Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Florida Real Estate Exam?",
