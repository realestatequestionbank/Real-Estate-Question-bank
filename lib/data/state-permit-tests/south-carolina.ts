...
export const southCarolinaPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'SC',
    departmentName: 'South Carolina Real Estate Commission',
    departmentAbbr: 'SCREC',
    realQuestionCount: 110,
    realPassCount: 77,
    passPercent: 70,
    timeLimit: '3 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/south-carolina-real-estate-practice-test',
    pageUrl: '/south-carolina-real-estate-practice-test-110-questions',
...
export const southCarolinaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real South Carolina Real Estate Exam?",
        answer: "The real South Carolina Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the South Carolina real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the South Carolina Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the South Carolina Real Estate Exam?",
