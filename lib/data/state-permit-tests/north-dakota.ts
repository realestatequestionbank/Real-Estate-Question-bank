...
export const northDakotaPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'ND',
    departmentName: 'North Dakota Real Estate Commission',
    departmentAbbr: 'NDREC',
    realQuestionCount: 110,
    realPassCount: 77,
    passPercent: 70,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/north-dakota-real-estate-practice-test',
    pageUrl: '/north-dakota-real-estate-practice-test-110-questions',
...
export const northDakotaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real North Dakota Real Estate Exam?",
        answer: "The real North Dakota Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the North Dakota real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the North Dakota Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the North Dakota Real Estate Exam?",
