...
export const arkansasPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Arkansas',
    stateCode: 'AR',
    departmentName: 'Arkansas Real Estate Commission',
    departmentAbbr: 'AREC',
    ...
    mainPageUrl: '/arkansas-real-estate-practice-test',
    pageUrl: '/arkansas-real-estate-practice-test-110-questions',
...
export const arkansasPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Arkansas Real Estate Exam?",
        answer: "The real Arkansas Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Arkansas real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Arkansas Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Arkansas Real Estate Exam?",
