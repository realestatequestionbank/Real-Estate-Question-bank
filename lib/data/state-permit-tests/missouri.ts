...
export const missouriPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Missouri',
    stateCode: 'MO',
    departmentName: 'Missouri Real Estate Commission',
    departmentAbbr: 'MREC',
    realQuestionCount: 100,
    realPassCount: 75,
    passPercent: 75,
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/missouri-real-estate-practice-test',
    pageUrl: '/missouri-real-estate-practice-test-100-questions',
...
export const missouriPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Missouri Real Estate Exam?",
        answer: "The real Missouri Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Missouri real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Missouri Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Missouri Real Estate Exam?",
