...
export const illinoisPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Illinois',
    stateCode: 'IL',
    departmentName: 'Illinois Department of Financial and Professional Regulation',
    departmentAbbr: 'IDFPR',
    realQuestionCount: 100,
    realPassCount: 75,
    passPercent: 75,
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/illinois-real-estate-practice-test',
    pageUrl: '/illinois-real-estate-practice-test-100-questions',
...
export const illinoisPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Illinois Real Estate Exam?",
        answer: "The real Illinois Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Illinois real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Illinois Department of Financial and Professional Regulation guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Illinois Real Estate Exam?",
