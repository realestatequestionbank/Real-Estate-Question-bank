...
export const californiaPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'CA',
    departmentName: 'California Department of Real Estate',
    departmentAbbr: 'DRE',
    ...
    mainPageUrl: '/california-real-estate-practice-test',
    pageUrl: '/california-real-estate-practice-test-150-questions',
...
export const californiaPermitTestFaq: { question: string; answer: string }[] = [
    {
        ...
        answer: "The real California Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the California real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the California Department of Real Estate guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the California Real Estate Exam?",
