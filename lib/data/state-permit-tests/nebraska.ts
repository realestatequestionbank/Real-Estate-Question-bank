...
export const nebraskaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Nebraska',
    stateCode: 'NE',
    departmentName: 'Nebraska Real Estate Commission',
    departmentAbbr: 'NREC',
    ...
    mainPageUrl: '/nebraska-real-estate-practice-test',
    pageUrl: '/nebraska-real-estate-practice-test-110-questions',
...
export const nebraskaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Nebraska Real Estate Exam?",
        answer: "The real Nebraska Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Nebraska real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Nebraska Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Nebraska Real Estate Exam?",
