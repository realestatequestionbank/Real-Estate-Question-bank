...
export const newHampshirePermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'NH',
    departmentName: 'New Hampshire Real Estate Commission',
    departmentAbbr: 'NHREC',
    realQuestionCount: 120,
    realPassCount: 84,
    passPercent: 70,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/new-hampshire-real-estate-practice-test',
    pageUrl: '/new-hampshire-real-estate-practice-test-120-questions',
...
export const newHampshirePermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real New Hampshire Real Estate Exam?",
        answer: "The real New Hampshire Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the New Hampshire real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the New Hampshire Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the New Hampshire Real Estate Exam?",
