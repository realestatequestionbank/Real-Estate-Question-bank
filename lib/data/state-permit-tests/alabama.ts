...
export const alabamaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Alabama',
    stateCode: 'AL',
    departmentName: 'Alabama Real Estate Commission',
    departmentAbbr: 'AREC',
    realQuestionCount: 100,
    realPassCount: 75,
    passPercent: 75,
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/alabama-real-estate-practice-test',
    pageUrl: '/alabama-real-estate-practice-test-100-questions',
...
export const alabamaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Alabama Real Estate Exam?",
        answer: "The real Alabama Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Alabama real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Alabama Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Alabama Real Estate Exam?",
