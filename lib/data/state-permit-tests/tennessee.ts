...
export const tennesseePermitTestConfig: StatePermitTestConfig = {
    stateName: 'Tennessee',
    stateCode: 'TN',
    departmentName: 'Tennessee Real Estate Commission',
    departmentAbbr: 'TREC',
    ...
    mainPageUrl: '/tennessee-real-estate-practice-test',
    pageUrl: '/tennessee-real-estate-practice-test-120-questions',
...
export const tennesseePermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Tennessee Real Estate Exam?",
        answer: "The real Tennessee Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Tennessee real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Tennessee Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Tennessee Real Estate Exam?",
