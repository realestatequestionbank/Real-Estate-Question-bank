...
export const vermontPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Vermont',
    stateCode: 'VT',
    departmentName: 'Vermont Real Estate Commission',
    departmentAbbr: 'VREC',
    ...
    mainPageUrl: '/vermont-real-estate-practice-test',
    pageUrl: '/vermont-real-estate-practice-test-110-questions',
...
export const vermontPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Vermont Real Estate Exam?",
        answer: "The real Vermont Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Vermont real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Vermont Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Vermont Real Estate Exam?",
