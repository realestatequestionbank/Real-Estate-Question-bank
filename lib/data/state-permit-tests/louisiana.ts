...
export const louisianaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Louisiana',
    stateCode: 'LA',
    departmentName: 'Louisiana Real Estate Commission',
    departmentAbbr: 'LREC',
    realQuestionCount: 135,
    realPassCount: 95,
    passPercent: 70,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/louisiana-real-estate-practice-test',
    pageUrl: '/louisiana-real-estate-practice-test-135-questions',
...
export const louisianaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Louisiana Real Estate Exam?",
        answer: "The real Louisiana Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Louisiana real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Louisiana Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Louisiana Real Estate Exam?",
