...
export const minnesotaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Minnesota',
    stateCode: 'MN',
    departmentName: 'Minnesota Department of Commerce',
    departmentAbbr: 'MNDOC',
    realQuestionCount: 130,
    realPassCount: 97,
    passPercent: 75,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/minnesota-real-estate-practice-test',
    pageUrl: '/minnesota-real-estate-practice-test-130-questions',
...
export const minnesotaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Minnesota Real Estate Exam?",
        answer: "The real Minnesota Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Minnesota real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Minnesota Department of Commerce guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Minnesota Real Estate Exam?",
