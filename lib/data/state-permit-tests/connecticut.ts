...
export const connecticutPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'CT',
    departmentName: 'Connecticut Department of Consumer Protection',
    departmentAbbr: 'DCP',
    ...
    mainPageUrl: '/connecticut-real-estate-practice-test',
    pageUrl: '/connecticut-real-estate-practice-test-110-questions',
...
export const connecticutPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Connecticut Real Estate Exam?",
        answer: "The real Connecticut Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Connecticut real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Connecticut Department of Consumer Protection guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Connecticut Real Estate Exam?",
