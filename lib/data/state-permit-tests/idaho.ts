...
export const idahoPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Idaho',
    stateCode: 'ID',
    departmentName: 'Idaho Real Estate Commission',
    departmentAbbr: 'IREC',
    ...
    mainPageUrl: '/idaho-real-estate-practice-test',
    pageUrl: '/idaho-real-estate-practice-test-130-questions',
...
export const idahoPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Idaho Real Estate Exam?",
        answer: "The real Idaho Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Idaho real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Idaho Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Idaho Real Estate Exam?",
