...
export const georgiaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Georgia',
    stateCode: 'GA',
    departmentName: 'Georgia Real Estate Commission',
    departmentAbbr: 'GREC',
    realQuestionCount: 152,
    realPassCount: 114,
    passPercent: 75,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/georgia-real-estate-practice-test',
    pageUrl: '/georgia-real-estate-practice-test-152-questions',
...
export const georgiaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Georgia Real Estate Exam?",
        answer: "The real Georgia Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Georgia real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Georgia Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Georgia Real Estate Exam?",
