...
export const newJerseyPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'NJ',
    departmentName: 'New Jersey Real Estate Commission',
    departmentAbbr: 'NJREC',
    realQuestionCount: 110,
    realPassCount: 77,
    passPercent: 70,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/new-jersey-real-estate-practice-test',
    pageUrl: '/new-jersey-real-estate-practice-test-110-questions',
...
export const newJerseyPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real New Jersey Real Estate Exam?",
        answer: "The real New Jersey Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the New Jersey real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the New Jersey Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the New Jersey Real Estate Exam?",
