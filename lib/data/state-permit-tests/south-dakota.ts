...
export const southDakotaPermitTestConfig: StatePermitTestConfig = {
    ...
    stateCode: 'SD',
    departmentName: 'South Dakota Real Estate Commission',
    departmentAbbr: 'SDREC',
    realQuestionCount: 140,
    realPassCount: 98,
    passPercent: 70,
    timeLimit: '4 Hours',
    retakePolicy: 'May retake after scheduled waiting period',
    mainPageUrl: '/south-dakota-real-estate-practice-test',
    pageUrl: '/south-dakota-real-estate-practice-test-140-questions',
...
export const southDakotaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real South Dakota Real Estate Exam?",
        answer: "The real South Dakota Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the South Dakota real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the South Dakota Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the South Dakota Real Estate Exam?",
