...
export const nevadaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Nevada',
    stateCode: 'NV',
    departmentName: 'Nevada Real Estate Division',
    departmentAbbr: 'NRED',
    ...
    mainPageUrl: '/nevada-real-estate-practice-test',
    pageUrl: '/nevada-real-estate-practice-test-120-questions',
...
export const nevadaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Nevada Real Estate Exam?",
        answer: "The real Nevada Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Nevada real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Nevada Real Estate Division guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Nevada Real Estate Exam?",
