...
export const oregonPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Oregon',
    stateCode: 'OR',
    departmentName: 'Oregon Real Estate Agency',
    departmentAbbr: 'OREA',
    ...
    mainPageUrl: '/oregon-real-estate-practice-test',
    pageUrl: '/oregon-real-estate-practice-test-150-questions',
...
export const oregonPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Oregon Real Estate Exam?",
        answer: "The real Oregon Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Oregon real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Oregon Real Estate Agency guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Oregon Real Estate Exam?",
