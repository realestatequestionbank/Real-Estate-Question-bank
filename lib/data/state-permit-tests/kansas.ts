...
export const kansasPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Kansas',
    stateCode: 'KS',
    departmentName: 'Kansas Real Estate Commission',
    departmentAbbr: 'KREC',
    ...
    mainPageUrl: '/kansas-real-estate-practice-test',
    pageUrl: '/kansas-real-estate-practice-test-110-questions',
...
export const kansasPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Kansas Real Estate Exam?",
        answer: "The real Kansas Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Kansas real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Kansas Real Estate Commission guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Kansas Real Estate Exam?",
