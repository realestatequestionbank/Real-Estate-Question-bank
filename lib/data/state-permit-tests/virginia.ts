...
export const virginiaPermitTestConfig: StatePermitTestConfig = {
    stateName: 'Virginia',
    stateCode: 'VA',
    departmentName: 'Virginia Real Estate Board',
    departmentAbbr: 'VREB',
    ...
    mainPageUrl: '/virginia-real-estate-practice-test',
    pageUrl: '/virginia-real-estate-practice-test-120-questions',
...
export const virginiaPermitTestFaq: { question: string; answer: string }[] = [
    {
        question: "How many questions are on the real Virginia Real Estate Exam?",
        answer: "The real Virginia Real Estate licensing exam typically has around 100 to 150 questions (divided between national and state portions). You must score 70% or 75% depending on state regulations to pass."
    },
    {
        question: "What is the passing score for the Virginia real estate license exam?",
        answer: "A passing score is generally 70% to 75% correct. Consult the Virginia Real Estate Board guidelines for your specific examination details."
    },
    {
        question: "Can I use a calculator on the Virginia Real Estate Exam?",
