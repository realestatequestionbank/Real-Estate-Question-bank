...
export function PracticeTest({ questions }: PracticeTestProps) {
    ...
    const [history, setHistory] = useState<{ questionId: string | number, isCorrect: boolean }[]>([])
        ...
        return (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 text-center max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    {passed
                        ? "You have a solid understanding of road signs & signals. Keep practicing to maintain your knowledge."
                        : "Review the signs shapes and colors section and try again. Recognition is key."
                    }
                </p>
    ...
    return (
        <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="flex flex-col-reverse md:grid md:grid-cols-12 gap-0 md:divide-x divide-gray-100">
                    {/* Left Column: Question & Options */}
                    <div className={cn(
                        "p-5 md:p-8 flex flex-col justify-center",
                        currentQuestion.imageUrl ? "md:col-span-7 lg:col-span-8" : "md:col-span-12"
                    )}>
                        {/* Question Header */}
                            ...
                            {currentQuestion.options.map((option, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {showCorrect && <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 ml-2" />}
                    ...
                    {currentQuestion.imageUrl && (
                        <div className="md:col-span-5 lg:col-span-4 bg-gray-50 p-6 md:p-8 flex items-center justify-center border-b md:border-none border-gray-100">
                            <div className="relative w-full aspect-square md:aspect-[4/5] max-w-[180px] md:max-w-sm mx-auto">
                                <Image
