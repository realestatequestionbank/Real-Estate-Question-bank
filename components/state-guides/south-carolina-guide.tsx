...
export function SouthCarolinaGuide() {
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-gray-900 font-medium">South Carolina Guide</span>
          </nav>
        </div>
      </div>
          ...
          <article className="max-w-3xl flex-1 min-w-0">
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
                South Carolina Real Estate License Exam 2026
              </h1>
              <p className="text-lg text-gray-500 leading-relaxed">
                A complete walkthrough of everything required to get your South Carolina Real Estate License and pass the state licensing exam.
                ...
                <Link href="/south-carolina-real-estate-practice-test" className="underline decoration-[#007aff] underline-offset-2 hover:text-[#007aff]">
                  free South Carolina Real Estate practice test
                </Link>.
              </p>
              <div className="flex items-center gap-4 mt-6 pt-6 border-t border-gray-200">
                <span className="text-xs text-gray-400">Last verified 2026</span>
                <span className="text-xs text-gray-300">|</span>
                <OutLink href="https://llr.sc.gov/rec/">
            ...
            <section id="eligibility" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  To earn a real estate salesperson or broker license in South Carolina, you must meet the following eligibility requirements:
                </p>
            ...
            <section id="education" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  South Carolina requires all candidates to complete an approved <strong>90-hour pre-licensing education program</strong> before taking the exam.
                </p>
                <p>
            ...
            <section id="fees" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Getting licensed in South Carolina involves a few standard costs:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li><strong>Exam Fee:</strong> Paid when scheduling the state exam (typically around $60 - $100).</li>
                  <li><strong>License Application Fee:</strong> Paid to the South Carolina Real Estate Commission to issue the license (approximately $125).</li>
            ...
            <section id="written-test" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  The South Carolina Real Estate Licensing Exam is a computer-based multiple-choice test consisting of two distinct portions:
                </p>
                <ol className="list-decimal pl-5 space-y-3">
                  ...
                  <li>
                    <strong>State-Specific Real Estate Laws (approx. 40-60 questions):</strong> Focuses on South Carolina license law, commission rules, advertising rules, escrow accounts, agency disclosure requirements, and state penalties.
                  </li>
                </ol>
              </div>
            </section>
            ...
            <section id="after-passing" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Passing the exam is not enough to begin working. In South Carolina, your real estate license will be issued in an "inactive" status.
                </p>
                <p>
                  To activate your license and start representing buyers and sellers, you must align with an active, licensed <strong>sponsoring broker</strong>. Once a sponsoring broker submits the sponsorship confirmation, the South Carolina Real Estate Commission will activate your license.
                </p>
              </div>
            </section>
            ...
            <section id="reference" className="mb-14 scroll-mt-24">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                <OutLink href="https://llr.sc.gov/rec/">South Carolina Real Estate Commission</OutLink>.
              </p>
            </section>
          </article>
        </div>
