...
export function WashingtonGuide() {
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-gray-900 font-medium">Washington Guide</span>
          </nav>
        </div>
      </div>
          ...
          <article className="max-w-3xl flex-1 min-w-0">
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
                Washington Real Estate License Exam 2026
              </h1>
              <p className="text-lg text-gray-500 leading-relaxed">
                A complete walkthrough of everything required to get your Washington Real Estate License and pass the state licensing exam.
                ...
                <Link href="/washington-real-estate-practice-test" className="underline decoration-[#007aff] underline-offset-2 hover:text-[#007aff]">
                  free Washington Real Estate practice test
                </Link>.
              </p>
              <div className="flex items-center gap-4 mt-6 pt-6 border-t border-gray-200">
                <span className="text-xs text-gray-400">Last verified 2026</span>
                <span className="text-xs text-gray-300">|</span>
                <OutLink href="https://www.dol.wa.gov">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-200 border border-gray-200 rounded-xl overflow-hidden mb-14">
              {[
                ...
                { label: "Commission", value: "Commission", sub: "Washington" },
            ...
            <section id="eligibility" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  To earn a real estate salesperson or broker license in Washington, you must meet the following eligibility requirements:
                </p>
            ...
            <section id="education" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Washington requires all candidates to complete an approved <strong>90-hour pre-licensing education program</strong> before taking the exam.
                </p>
                <p>
            ...
            <section id="fees" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Getting licensed in Washington involves a few standard costs:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li><strong>Exam Fee:</strong> Paid when scheduling the state exam (typically around $60 - $100).</li>
                  <li><strong>License Application Fee:</strong> Paid to the Washington State Department of Licensing (DOL) to issue the license (approximately $138.25).</li>
            ...
            <section id="written-test" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  The Washington Real Estate Licensing Exam is a computer-based multiple-choice test consisting of two distinct portions:
                </p>
                <ol className="list-decimal pl-5 space-y-3">
                  ...
                  <li>
                    <strong>State-Specific Real Estate Laws (approx. 40-60 questions):</strong> Focuses on Washington license law, commission rules, advertising rules, escrow accounts, agency disclosure requirements, and state penalties.
                  </li>
                </ol>
              </div>
            </section>
            ...
            <section id="after-passing" className="mb-14 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Passing the exam is not enough to begin working. In Washington, your real estate license will be issued in an "inactive" status.
                </p>
                <p>
                  To activate your license and start representing buyers and sellers, you must align with an active, licensed <strong>sponsoring broker</strong>. Once a sponsoring broker submits the sponsorship confirmation, the Washington State Department of Licensing (DOL) will activate your license.
                </p>
              </div>
            </section>
            ...
            <section id="reference" className="mb-14 scroll-mt-24">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                <OutLink href="https://www.dol.wa.gov">Washington State Department of Licensing (DOL)</OutLink>.
              </p>
            </section>
          </article>
        </div>
