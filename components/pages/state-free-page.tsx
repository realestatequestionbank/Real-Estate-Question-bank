          ...
          <div className="w-full max-w-[1440px] mx-auto px-4 md:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="bg-[#f0f4f8] hover:bg-[#e7eef5] rounded-2xl p-6 md:p-8 text-center transition-all duration-200 hover:shadow-md">
                ...
                <div className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-gray-900 mt-2 md:mt-3 leading-none">{formatQuestionCount(stateData.pricing.premiumQuestions)}</div>
              </div>
              <div className="bg-[#f0f4f8] hover:bg-[#e7eef5] rounded-2xl p-6 md:p-8 text-center transition-all duration-200 hover:shadow-md">
