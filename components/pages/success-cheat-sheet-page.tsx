...
const PDF_FILE_NAMES: Record<StateKey, string> = {
  ...
  'hawaii': 'Free-Hawaii-DOT-Practice-Questions.pdf',
  ...
  'south-carolina': 'Free-South-Carolina-SCRealEstate-Practice-Questions.pdf',
  ...
  'utah': 'Free-Utah-DLD-Practice-Questions.pdf',
