        ...
        return (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 text-center max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    {passed
                        ? "You have a solid understanding of traffic signals and road markings. Keep practicing to maintain your knowledge."
                        : "Review the rules and try again. Knowing signals and markings is essential for safe driving."
                    }
                </p>
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    !isAnswered && !isSelected && "border-gray-200 hover:border-green-300 hover:bg-green-50",
                                    !isAnswered && isSelected && "border-green-500 bg-green-50 ring-1 ring-green-500",
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className={cn(
                                        ...
                                        !isAnswered && !isSelected && "border-gray-300 text-gray-500 group-hover:border-green-400 group-hover:text-green-600",
                                        !isAnswered && isSelected && "border-green-500 bg-green-500 text-white",
                ...
                {isAnswered && (
                    <div className="bg-green-50/50 p-6 md:p-8 border-t border-green-100 animate-in fade-in slide-in-from-bottom-4 duration-300">
                        <div className="flex items-start gap-3 mb-6">
                            <div className="bg-green-100 text-green-600 p-2 rounded-lg mt-0.5">
                                <AlertCircle className="w-5 h-5" />
                            </div>
                            <div className="flex-1">
                                <h4 className="font-bold text-green-900 mb-1">Explanation</h4>
