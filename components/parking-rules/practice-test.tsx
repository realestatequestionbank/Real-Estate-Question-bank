        ...
        return (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 text-center max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    {passed
                        ? "You understand parking rules and curb markings. These skills will help you avoid tickets!"
                        : "Review the parking rules and try again. Knowing where to park legally is essential."
                    }
                </p>
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    !isAnswered && !isSelected && "border-gray-200 hover:border-teal-300 hover:bg-teal-50",
                                    !isAnswered && isSelected && "border-teal-500 bg-teal-50 ring-1 ring-teal-500",
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className={cn(
                                        ...
                                        !isAnswered && !isSelected && "border-gray-300 text-gray-500 group-hover:border-teal-400 group-hover:text-teal-600",
                                        !isAnswered && isSelected && "border-teal-500 bg-teal-500 text-white",
                ...
                {isAnswered && (
                    <div className="bg-teal-50/50 p-6 md:p-8 border-t border-teal-100 animate-in fade-in slide-in-from-bottom-4 duration-300">
                        <div className="flex items-start gap-3 mb-6">
                            <div className="bg-teal-100 text-teal-600 p-2 rounded-lg mt-0.5">
                                <AlertCircle className="w-5 h-5" />
                            </div>
                            <div className="flex-1">
                                <h4 className="font-bold text-teal-900 mb-1">Explanation</h4>
