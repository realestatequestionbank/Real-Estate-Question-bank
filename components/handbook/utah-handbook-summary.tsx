...
export function UtahHandbookSummary() {
    ...
    const breadcrumbs = [
        ...
        { label: 'Utah', href: '/utah-real-estate-practice-test' },
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row items-start gap-8 md:gap-6">
                        ...
                        <div className="w-full md:w-auto max-w-3xl text-left pt-2 md:pt-6">
                            <Link
                                href="/utah-real-estate-practice-test"
                            ...
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                                Summary of the Utah Driver Handbook {currentYear}
                            </h1>
                            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-3">
                                ...
                                >
                                    official {currentYear} Utah Driver&apos;s Handbook
                                    <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-[#007aff] transition-all duration-300 group-hover:w-full"></span>
                                </Link>
                                . We break down all 10 key topics — from getting your license and right-of-way rules to speed limits, DUI laws, and what to do in a crash. Each section highlights the key rules and numbers the Utah Real Estate actually tests you on.
                            </p>
                        ...
                        <div className="w-full flex justify-center md:w-auto md:ml-12 lg:ml-20 md:mr-auto mt-2 md:mt-4 pt-2">
                            <div className="relative">
                                <Image
                                    src="/handbook-summary/utah/utah-handbook-image.png?v=3"
                                    alt="Utah Real Estate Driver Handbook 2026"
                                    width={200}
                                    height={260}
            ...
            <main className="py-10 md:py-14">
                <div className="container mx-auto px-4">
                    <div className="space-y-10 md:space-y-12">
                        ...
                        <SectionCard id="section-1" number={1} title="Getting Your Utah Driver License">
                            <p>
                                Driving in Utah is a <strong>privilege, not a right</strong>. All Utah residents must hold a valid Utah driver license.
                                New residents must obtain a Utah license within <strong>30 days</strong> of establishing residency.
                            </p>
                            <SubHeading>Types of Utah Licenses</SubHeading>
                            <BulletList items={[
                                <>
                        ...
                        <SectionCard id="section-2" number={2} title="Traffic Laws & Rules of the Road">
                            ...
                            <SubHeading>Utah Speed Limits</SubHeading>
                        ...
                        <SectionCard id="section-4" number={4} title="Safe & Defensive Driving Practices">
                            ...
                            <WarningBox title="Hands-Free Only" icon={<AlertTriangle className="w-4 h-4" />}>
                                <p className="text-sm text-gray-700">Utah law prohibits holding a cell phone while driving. <strong>Texting while driving is illegal.</strong> Drivers under 18 may not use a cell phone at all, even hands-free.</p>
                            </WarningBox>
                        </SectionCard>
                        ...
                        <SectionCard id="section-5" number={5} title="Driving in Special Conditions">
                            ...
                            <div className="space-y-3">
                                ...
                                <ConditionItem emoji="💨" name="High Winds">
                                    Utah desert roads can experience strong crosswinds, especially for high-profile vehicles. Grip the wheel firmly and reduce speed. Be prepared when exiting tunnels or passing gaps between mountains.
                                </ConditionItem>
                            </div>
                        ...
                        <SectionCard id="section-6" number={6} title="Alcohol, Drugs & Impaired Driving">
                            <p>
                                Alcohol and drugs impair judgment, vision, coordination, and reaction time. Utah law applies to
                        ...
                        <SectionCard id="section-7" number={7} title="Vehicle Ownership & Insurance">
                            ...
                            <BulletList items={[
                                <>Vehicles must be registered in Utah within <strong>30 days</strong> of establishing residency.</>,
                        ...
                        <SectionCard id="section-9" number={9} title="Motor Vehicle Crashes & Safety">
                            ...
                            <BulletList items={[
                                ...
                                <>If the crash involves injury, death, or property damage of <strong>$750 or more</strong>, you must report it to the Utah Real Estate within <strong>10 days</strong>.</>,
                            ...
                            <BulletList items={[
                                ...
                                <>Utah has <strong>primary enforcement</strong> — police can stop you just for a seat belt violation.</>,
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4">
                            Ready to Pass Your Utah real estate exam?
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Button asChild size="lg" className="group bg-white text-[#007aff] hover:bg-blue-50 font-semibold px-6 py-3 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 text-sm md:text-base w-full sm:w-auto min-w-[240px] flex flex-row flex-nowrap items-center justify-center gap-2">
                                <Link href="/utah-real-estate-practice-test">
