...
const SECTIONS = [
    { id: 'section-1', label: "1. Driver's Licenses" },
    { id: 'section-2', label: '2. Keeping Your License' },
    { id: 'section-3', label: '3. Owning a Vehicle' },
    { id: 'section-4', label: '4. Traffic Control' },
    { id: 'section-5', label: '5. Intersections & Turns' },
    { id: 'section-6', label: '6. How to Pass' },
    { id: 'section-7', label: '7. Parallel Parking' },
    { id: 'section-8', label: '8. Defensive Driving' },
    { id: 'section-9', label: '9. Alcohol & Drugs' },
    { id: 'section-10', label: '10. Special Conditions' },
    { id: 'section-11', label: '11. Sharing the Road' },
    { id: 'section-12', label: '12. Traffic Crashes' },
];
...
export function NewYorkHandbookSummary() {
    const stateKey = "new-york";
    const stateName = "New York";
    const departmentName = "Real Estate";
                    ...
                    <div className="flex flex-col md:flex-row items-start gap-8 md:gap-6">
                        ...
                        <div className="w-full md:w-auto max-w-3xl text-left pt-2 md:pt-6">
                            ...
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                                Summary of New York (NY) Real Estate Handbook 2026
                            </h1>
                            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-3">
                                A comprehensive, exam-focused summary of the{' '}
                                <Link
                                    href={`/handbooks/new-york`}
                                    className="text-[#007aff] font-medium relative inline-block group"
                                >
                                    official {currentYear} New York Driver Handbook
                                    <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-[#007aff] transition-all duration-300 group-hover:w-full"></span>
                                </Link>
                                . We break down all 12 chapters — from getting your permit and license requirements to right-of-way rules, speed limits, DWI laws, and what to do in a collision. Each section highlights the key rules and numbers the New York Real Estate actually tests you on.
                            </p>
                        ...
                        <div className="w-full flex justify-center md:w-auto md:ml-12 lg:ml-20 md:mr-auto mt-2 md:mt-4 pt-2">
                            <div className="relative">
                                <Image
                                    src="/handbook-summary/new-york/new-york-handbook-image-v2.png"
                                    alt="New York Real Estate Driver Handbook 2026"
                                    width={200}
                                    height={260}
            ...
            <main className="py-10 md:py-14">
                <div className="container mx-auto px-4">
                    <div className="space-y-10 md:space-y-12">
                        ...
                        {/* ===== Section 1: The New York Driver's License (pp. 7) ===== */}
                        <SectionCard id="section-1" number={1} title="The New York Driver's License">
                            <p>
                                A New York real estate license allows you to drive on public roads. Most people need a
                                noncommercial <strong>Class D</strong> real estate license to operate standard vehicles. Driving in
                                New York is a <strong>privilege, not a right</strong>.
                            </p>
                            ...
                            <BulletList items={[
                                <>
                                    ...
                                    star) to board domestic flights, enter military bases, and access most federal facilities.
                                </>,
                                <>
                                    <strong>Veteran Designation:</strong> Available for eligible veterans — see real-estate.ny.gov/more-info/veteran-status-designation-photo-document.
                                </>,
                                <>
                        ...
                        <SectionCard id="section-2" number={2} title="Getting an Instruction Permit and Driver's License">
                            <p>
                                If you do not have a license from New York or another state, you must apply for an
                            ...
                            <BulletList items={[
                                ...
                                'Two proofs of New York residency.',
                            ...
                            <BulletList items={[
                                <>Practice driving with a licensed driver who is at least 21 years old. This person must sit close enough to take control if needed.</>,
                                'Pass a road test (You must complete a 5-hour pre-licensing course before scheduling).',
                            ]} />
                        ...
                        <SectionCard id="section-6" number={6} title="Navigating the Roads">
                            ...
                            <BulletList items={[
                                ...
                                'Remain inside your vehicle and await instructions.',
                        ...
                        <SectionCard id="section-7" number={7} title="Laws and Rules of the Road">
                            ...
                            <BulletList items={[
                                ...
                                'Give motorcycles a full lane width. Lane splitting (sharing a lane) is illegal in New York.',
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
                                {[
                                    ...
                                    { limit: '55 mph', where: 'State maximum speed limit (unless a different limit is posted)' },
                                    { limit: '25 mph', where: 'New York City maximum speed limit (unless posted otherwise)' },
                                    { limit: '15 mph', where: 'Specified school zones (during school days/hours)' },
                                ].map((item) => (
                            ...
                            <BulletList items={[
                                <>Your license may be suspended if you accumulate: <strong>11 points in 18 months</strong>.</>,
                                'Traffic convictions stay on your record for standard periods (usually 3-4 years).',
                        ...
                        <SectionCard id="section-9" number={9} title="Alcohol and Drugs">
                            ...
                            <p>
                                New York DWI/DWAI laws apply to both alcohol <strong>and drugs</strong> — including prescription and over-the-counter
                            ...
                            <BulletList items={[
                                'By driving in New York, you consent to a breath, blood, or urine test if arrested for DWI.',
                                <><strong>Refusal to test</strong> results in at least a 1-year license revocation.</>,
                            ]} />
