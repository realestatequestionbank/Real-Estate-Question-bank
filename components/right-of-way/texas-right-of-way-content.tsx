...
import { ArrowRight, AlertTriangle, ShieldCheck, ChevronRight, Siren, Bus, HelpCircle, CheckCircle2, AlertCircle, Crown, ScrollText } from 'lucide-react'
...
interface TexasRightOfWayContentProps {
    faqData: { question: string; answer: string }[]
}

export function TexasRightOfWayContent({ faqData }: TexasRightOfWayContentProps) {
                ...
                <section className="relative overflow-hidden bg-white">
                    ...
                    <div className="relative lg:hidden w-full h-56 overflow-hidden">
                        <Image
                            ...
                            alt="Texas Right-of-Way Rules Illustration"
                            fill
                            sizes="100vw"
                            quality={65}
                            ...
                            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                                ...
                                <div className="text-left">
                                    ...
                                    <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold text-black mb-4 md:mb-6" style={{ lineHeight: '1.2' }}>
                                        Texas DPS <span className="text-[#007aff]">Right-of-Way</span> Rules Permit Practice Test {currentYear}
                                    </h1>
                                    <p className="text-base text-gray-600 mb-8 md:mb-10 max-w-2xl leading-relaxed">
                                        Master Texas&apos;s right-of-way rules for intersections, roundabouts, and pedestrians with 25 challenging practice questions. Right-of-way errors are a leading cause of crashes across Texas and make up about 25% of the DPS written knowledge test.
                                    </p>
                        ...
                        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                            <div>
                                ...
                                <div className="prose prose-gray max-w-none">
                                    <p className="text-base text-gray-700 leading-relaxed mb-4">
                                        Understanding Texas&apos;s right-of-way rules is essential for passing the DPS knowledge test — and for staying safe on Texas roads. Right-of-way questions appear consistently on the exam, making this one of the most heavily tested topics.
                                    </p>
                                    <p className="text-base text-gray-700 leading-relaxed mb-4">
                                        This free practice test covers every right-of-way scenario you&apos;ll face on the actual DPS exam. The questions are intentionally challenging because these topics are frequently tested. You&apos;ll learn about 4-way stops, uncontrolled intersections, roundabout entry rules, pedestrian crosswalk laws, emergency vehicle procedures, and school bus regulations as defined by Texas Transportation Code §545.
                                    </p>
                                    <p className="text-base text-gray-700 leading-relaxed">
                                        Expect questions about: who goes first at a 4-way stop when vehicles arrive simultaneously, what to do at uncontrolled intersections, how to navigate roundabouts safely, when you must yield to pedestrians, Texas&apos;s Move Over law for emergency vehicles, and school bus stopping requirements. These are real Texas laws you need to know.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col gap-6 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-base text-gray-700 leading-relaxed">
                                        The Texas DPS considers &quot;Failure to Yield&quot; one of the most dangerous driving behaviors. Texas consistently ranks among the top states for traffic fatalities, making right-of-way knowledge critical. You must master:
                                    </p>
                        ...
                        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                            <div className="space-y-6 md:space-y-8">
                                <div>
                                    ...
                                    <p className="text-base text-gray-700 leading-relaxed mb-4">
                                        Under Texas Transportation Code §545.153, the golden rule at a 4-way stop is clear: <strong>First to stop, first to go.</strong> If two vehicles arrive at the same time, the vehicle on the <strong>right</strong> has the right-of-way. Texas law requires all vehicles to come to a complete stop before proceeding.
                                    </p>
                                    ...
                                    <div className="bg-yellow-50 p-5 md:p-6 rounded-2xl border border-yellow-100">
                                        <h3 className="text-lg font-bold text-yellow-900 mb-2 flex items-center gap-2">
                                            ...
                                            DPS Test Tip: Left Turns
                                        </h3>
                                        <p className="text-sm text-yellow-900/80 leading-relaxed">
                                            A common test question: &quot;You want to turn left at an intersection. The light is green but oncoming traffic is approaching.&quot;
                                        </p>
                                        <p className="text-sm text-yellow-900/80 mt-2 font-medium">
                                            Answer: Under §545.152, you must yield to oncoming traffic before completing the turn. You may enter the intersection to wait, but must not complete the turn until it is clear. A protected green arrow is the only exception.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100">
                                    <h3 className="text-lg font-bold text-gray-900 mb-2 flex items-center gap-2">
                                        ...
                                        Other Key Texas Rules
                                    </h3>
                                    <ul className="space-y-2 text-sm text-gray-600">
                                        <li>• <strong>T-Intersections:</strong> Traffic on the through road has the right-of-way. Vehicles on the road ending must yield (§545.151).</li>
                                        <li>• <strong>Uncontrolled Intersections:</strong> Yield to vehicle already in the intersection, then to vehicle on right (§545.151).</li>
                                        <li>• <strong>Private Roads/Driveways:</strong> Yield to all traffic and pedestrians on the public road before entering (§545.155).</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                            ...
                            <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
                                <div>
                                    ...
                                    <p className="text-base text-gray-700 leading-relaxed">
                                        Texas has expanded its use of roundabouts across the state as TxDOT data shows they reduce fatal crashes by up to 82% compared to traditional intersections. The rule is strictly <strong>Yield on Entry</strong>. Traffic already inside the circle always has the right-of-way. Travel <strong>counter-clockwise</strong> and signal when exiting.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Never stop <em>inside</em> a Texas roundabout to let someone enter. This causes accidents and defeats the roundabout&apos;s purpose. If you miss your exit, continue around and exit on the next pass.
                                    </p>
                                </div>
                                ...
                                <div className="flex gap-4 p-4 bg-red-50 rounded-xl border border-red-100">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-red-900">Exam Alert: Highway &amp; Freeway Merging</h4>
                                        <p className="text-sm text-red-800/80 mt-1">
                                            When entering a Texas highway, you must accelerate to match the speed of traffic. Drivers already on the highway have the right-of-way. <strong>Do not stop in the acceleration lane</strong> — this is dangerous and a common cause of rear-end crashes in Texas.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                            <div className="space-y-6 md:space-y-8">
                                <div>
                                    ...
                                    <p className="text-base text-gray-700 leading-relaxed mb-4">
                                        Texas Transportation Code §552.003 requires drivers to yield to pedestrians at all marked crosswalks. Texas law also recognizes <strong>implied crosswalks</strong> at every intersection — even where no lines are painted — and requires drivers to exercise due care for pedestrian safety.
                                    </p>
                                    ...
                                    <div className="bg-blue-50 p-5 md:p-6 rounded-2xl border border-blue-100">
                                        <p className="text-sm text-blue-900 font-medium italic">
                                            &quot;When in doubt, yield. Texas law requires you to exercise due care to avoid colliding with a pedestrian regardless of where they are crossing. Even a jaywalking pedestrian has a right not to be struck.&quot;
                                        </p>
                                    </div>

                                    <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 mt-4">
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Blind Pedestrians (§552.009)</h3>
                                        <p className="text-sm text-gray-600">
                                            Texas law gives the highest level of protection to pedestrians using white canes or guide dogs. You must stop your vehicle and yield the entire roadway until the pedestrian has safely reached the sidewalk. Violations carry fines of up to $500 in Texas.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl md:rounded-3xl p-6 md:p-10 border border-red-100">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Emergency Vehicles (§545.156)</h3>
                                        <p className="text-sm text-gray-700 mb-3">
                                            When you see lights or hear sirens, you must <strong>pull to the right and stop</strong>. Texas law (§545.156) is explicit — this is a mandatory requirement, not a courtesy.
                                        </p>
                                        <ul className="space-y-2 text-sm text-gray-700 bg-white/50 p-4 rounded-xl">
                                            <li>• <strong>Intersection:</strong> Clear the intersection first, then pull to the right and stop. Never stop inside an intersection.</li>
                                            <li>• <strong>Texas Move Over Law (§545.157):</strong> When passing a stopped emergency or authorized vehicle on the roadside, move over one lane or slow to 20 mph below the posted speed limit. First violation: up to $200. If the violation causes damage or injury, penalties increase significantly.</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-white/50 p-4 rounded-xl space-y-3">
                                            <div>
                                                ...
                                                <span className="text-sm text-gray-700">All traffic in both directions must stop at least 20 feet from the bus.</span>
                                            </div>
                                            <div>
                                                <span className="text-sm font-bold block mb-1">Divided Highway:</span>
                                                <span className="text-sm text-gray-700">Only traffic following the bus must stop. Oncoming traffic on the other side of a raised median may proceed with caution.</span>
                                            </div>
                                            <div>
                                                <span className="text-sm font-bold block mb-1">Texas Penalty:</span>
                                                <span className="text-sm text-gray-700">First offense: $500–$1,250 fine. Second or subsequent offense: $1,000–$2,000 + possible license suspension.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12 md:mb-16 max-w-2xl mx-auto">
                            ...
                            <p className="text-base text-gray-600">
                                These 25 questions mimic the real Texas DPS exam&apos;s &quot;Right of Way&quot; section. Can you score the passing 70%?
                            </p>
                        </div>
                        ...
                        <div className="mt-12 max-w-3xl mx-auto text-center">
                            <p className="text-sm text-gray-500 leading-relaxed">
                                ...
                                {' '}and the Texas Transportation Code (TTC Title 7, Chapter 545).
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 md:py-24 bg-gray-900 text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
                        ...
                        <p className="text-base text-gray-400 mb-8 md:mb-10">
                            Right-of-way is just one section. Get your Texas-specific premium study pack with a pass guarantee.
                        </p>
