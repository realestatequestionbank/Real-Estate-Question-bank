        ...
        return (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 text-center max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    {passed
                        ? "You have a solid understanding of right-of-way rules. Keep practicing to maintain your knowledge."
                        : "Review the rules and try again. Right-of-way concepts are crucial for your safety."
                    }
                </p>
