...
export function SignDetailContent({ slug }: SignDetailContentProps) {
        ...
        <div className="min-h-screen bg-white font-sans">
            ...
            <main>
                ...
                <div className="container mx-auto px-4 py-8 md:py-12">
                    <Link
                        href="/california-road-warning-signs"
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
                        ...
                        <div className="bg-gray-50 rounded-3xl p-10 md:p-16 flex items-center justify-center border border-gray-100">
                            <Image
                                src={sign.image}
                                alt={`California ${sign.title} Warning Sign Meaning`}
                                width={400}
                                height={400}
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="prose prose-lg text-gray-600 leading-relaxed">
                                    ...
                                    <p className="mt-4">
                                        Learn what the <strong>{sign.title}</strong> sign means for the <strong>road sign portion</strong> of your <strong>California Real Estate Exam</strong>.
                                        Encountering this yellow diamond sign means you should heighten your awareness and be prepared to take action.
                                    </p>
                                </div>
                            </div>
