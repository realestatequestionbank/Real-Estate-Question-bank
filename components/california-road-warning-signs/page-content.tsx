                                ...
                                <div className="grid md:grid-cols-2 gap-8 items-center">
                                    <div className="text-center md:text-left order-2 md:order-1">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                            <Link href="/california-real-estate-practice-test#premium-section" className="inline-flex items-center justify-center px-8 py-4 bg-[#007aff] hover:bg-[#0056cc] text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-200 w-full sm:w-auto">
